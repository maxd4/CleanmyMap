...
def _repair_mojibake_text(value):
    """Répare les chaÃÆ'Æ'ÆÃÆ'â€ ÃÆ'Æ'â€ ÃÆ'Æ'ÆÃÆ'¢â'¬Ã...¡ÃÆ'Æ''ÃÆ''®nes mal décodées (ex: é / ÃÆ'Æ'ÆÃÆ'â€ ÃÆ'Æ'â€ ÃÆ'Æ'ÆÃÆ'¢â'¬Ã...¡ÃÆ'Æ''ÃÆ''Â°ÃÆ'Æ'ÆÃÆ'†...ÃÆ'Æ'ÆÃÆ'¢â'¬Ã...¡ÃÆ'Æ''ÃÆ''¸...) sans impacter le texte sain."""
    ...
    markers = ("ÃÆ'Æ'ÆÃÆ'â€ ÃÆ'Æ'â€ ÃÆ'Æ'ÆÃÆ'¢â'¬ '", "ÃÆ'Æ'ÆÃÆ'â€ ÃÆ'Æ'â€ ÃÆ'Æ'ÆÃÆ'¢â'¬Ã...¡ÃÆ'Æ''ÃÆ''¢€", "'", "ÃÆ'Æ'ÆÃÆ'â€ ÃÆ'Æ'â€ ÃÆ'Æ'ÆÃÆ'¢â'¬Ã...¡ÃÆ'Æ''ÃÆ''Â°ÃÆ'Æ'ÆÃÆ'†...ÃÆ'Æ'ÆÃÆ'¢â'¬Ã...¡ÃÆ'Æ''ÃÆ''¸", "ÃÆ'Æ'ÆÃÆ'â€ ÃÆ'Æ'â€ ÃÆ'Æ'ÆÃÆ''¢ÃÆ'Æ'¢ÃÆ'¢â'¬Ã...¡ÃÆ''¬ÃÆ'Æ'...ÃÆ''¡", "ÃÆ'Æ'ÆÃÆ'â€ ÃÆ'Æ''ÃÆ''¯ÃÆ'Æ'ÆÃÆ'¢â'¬Ã...¡ÃÆ'Æ''ÃÆ''¿ÃÆ'Æ'ÆÃÆ'¢â'¬Ã...¡ÃÆ'Æ''ÃÆ''½")
...
def get_impact_sources():
    """Wrapper vers le service impact pour conserver l'API historique cÃÆ'Æ'ÆÃÆ'â€ ÃÆ'Æ'â€ ÃÆ'Æ'ÆÃÆ'¢â'¬Ã...¡ÃÆ'Æ''ÃÆ''´té app."""
...
PRODUCT_CHANGELOG = [
    {
        ...
        "details_fr": "Ajout d'un suivi des erreurs UX (champs invalides et actions cassées) et d'un socle Playwright sur les flux critiques.",
...
def render_maintenance_diagnostic_panel(project_root: Path) -> None:
    ...
    with col_b2:
        st.info(
            i18n_text(
                "Ce diagnostic vérifie l'hygiène projet sans suppression ni réécriture de fichiers.",
    ...
    if not diag_report:
        st.info(i18n_text("Aucun diagnostic lancé pour le moment.", "No diagnostic has been run yet."))
        return

    generated_at = str(diag_report.get("generated_at", "-"))
    st.caption(i18n_text(f"Dernière analyse : {generated_at}", f"Last analysis: {generated_at}"))
    is_clean = diag_report.get("status") == "clean"

    if is_clean:
        st.success(
            i18n_text(
                "Conforme : aucun point bloquant détecté.",
        ...
        st.warning(
            i18n_text(
                "Points à corriger : certaines règles de maintenance nécessitent une action.",
    ...
    if recommended_actions:
        ...
        st.write(i18n_text("Aucune action immédiate requise.", "No immediate action required."))

    with st.expander(i18n_text("Détails techniques (optionnel)", "Technical details (optional)"), expanded=False):
        for rule in rules:
...
st.markdown(
    ...
    /* Masquer les ancres automatiques des titres Streamlit (liens à cÃÆ'Æ'ÆÃÆ'â€ ÃÆ'Æ'â€ ÃÆ'Æ'ÆÃÆ'¢â'¬Ã...¡ÃÆ'Æ''ÃÆ''´té des titres) */
...
def add_elevations_to_graph(G):
    ...
    try:
        ...
        st.warning(f"Erreur lors de la récupération des altitudes: {exc}")
        return G

def calculate_flow_sinks(G, pollution_points_df, threshold_slope=0.03):
    """
    Identifie les points bas (sinks) oÃÆ'Æ'ÆÃÆ'â€ ÃÆ'Æ'â€ ÃÆ'Æ'ÆÃÆ'¢â'¬Ã...¡ÃÆ'Æ''ÃÆ''¹ les déchets convergent.
...
def build_interactive_folium_map(map_df: pd.DataFrame) -> folium.Map:
    ...
    if not map_df.empty:
        for _, row in map_df.iterrows():
            ...
            if pd.notna(start_lat) and pd.notna(start_lon) and pd.notna(end_lat) and pd.notna(end_lon):
                ...
                if not same_point:
                    start_label = sanitize_html_text(row.get("adresse_depart") or row.get("adresse") or "Départ", max_len=160)
                    end_label = sanitize_html_text(row.get("adresse_arrivee") or "Arrivée", max_len=160)
                    folium.PolyLine(
                        ...
                        opacity=0.8,
                        dash_array="8,6",
                        tooltip=f"Trajet déclaré: {place_name}",
                        popup=(
                            f"<b>💧ÃÆ'Æ'ÆÃÆ'¢â'¬Ã...¡ÃÆ'Æ''ÃÆ''­ Trajet déclaré</b><br>"
                            f"<b>Départ:</b> {start_label}<br>"
                            f"<b>Arrivée:</b> {end_label}"
                        ),
                    ).add_to(group_routes)
            ...
            # Marqueur ponctuel uniquement quand aucun polygone/trait n'a pu etre tracé
    ...
    legend.onAdd = function(map) {{
        ...
        div.innerHTML = `
            ...
            <b style="color:#475569; font-size:10px; text-transform:uppercase; letter-spacing:0.05em;">ÃÆ'Æ'ÆÃÆ''¢ÃÆ'Æ'¢ÃÆ'¢â'¬Ã...¡ÃÆ''¬ÃÆ'Æ''ÃÆ''¹ ÉTAT DES LIEUX</b><br>
            ...
            <div style="margin-top:5px; background:rgba(16,185,129,0.05); padding:8px; border-radius:12px; border:1px solid rgba(16,185,129,0.1);">
                <span>💨 <b>{_co2:.1f} kg</b> COÃÆ'Æ'ÆÃÆ'â€ ÃÆ'Æ''ÃÆ''¢ÃÆ'Æ'ÆÃÆ''¢ÃÆ'Æ'¢ÃÆ'¢â'¬Ã...¡ÃÆ''¬ÃÆ'Æ'...ÃÆ''¡ÃÆ'Æ'ÆÃÆ''¢ÃÆ'Æ'¢ÃÆ'¢â'¬Ã...¡ÃÆ''¬ÃÆ'Æ'...ÃÆ''¡ évité</span><br>
...
def geocode_and_resolve(location_input: str):
    """Tente de résoudre un emplacement (GPS ou texte) en (lat, lon, adresse_formatée)."""
...
def apply_map_preset(map_df: pd.DataFrame, preset_id: str) -> pd.DataFrame:
    ...
    if preset_id == "pollution":
        result = map_df[(~clean_col) & (type_col != "ÃÆ'Æ'ÆÃÆ'¢â'¬Â°tablissement Engagé (Label)")].copy()
...
def auto_enrich_actor(sub_id, actor_name, actor_type, location):
    ...
    try:
        ...
        description = f"Structure engagée opérant ÃÆ'Æ'Æ'  {location}. Reconnu pour ses actions en tant que {str(actor_type).lower()}."
...
st.markdown(
    ...
    <section class="app-shell animate-in">
        <h2 class="app-shell-title">
            {"Agir, Cartographier, Protéger" if st.session_state.lang == "fr" else "Act, Map, Protect"}
        </h2>
        <p class="app-shell-subtitle">
            {"Déclarez vos actions bénévoles, suivez leur impact en temps réel et priorisez les zones à traiter."
            if st.session_state.lang == "fr"
...
rubric_hints = {
    ...
    "pdf": i18n_text("Générez un rapport d'impact pret à partager.", "Generate a share-ready impact report."),
    ...
    "kit": i18n_text("QR codes et outils prets pour le terrain.", "Field-ready QR and operation kit."),
    ...
    "admin": i18n_text("Validation, contrÃÆ'Æ'ÆÃÆ'â€ ÃÆ'Æ'â€ ÃÆ'Æ'ÆÃÆ'¢â'¬Ã...¡ÃÆ'Æ''ÃÆ''´le qualité et exports.", "Validation, quality control, and exports."),
}
...
with prev_col:
    if st.button(
        i18n_text("ÃÆ'Æ'ÆÃÆ'â€ ÃÆ'Æ''ÃÆ''¢📆ÃÆ'Æ'ÆÃÆ'¢â'¬Ã...¡ÃÆ'Æ''ÃÆ'' Rubrique précédente", "ÃÆ'Æ'ÆÃÆ'â€ ÃÆ'Æ''ÃÆ''¢📆ÃÆ'Æ'ÆÃÆ'¢â'¬Ã...¡ÃÆ'Æ''ÃÆ'' Previous section"),
        key="rubric_prev_btn",
...
with next_col:
    if st.button(
        i18n_text("Rubrique suivante ÃÆ'Æ'ÆÃÆ'â€ ÃÆ'Æ''ÃÆ''¢📆'", "Next section ÃÆ'Æ'ÆÃÆ'â€ ÃÆ'Æ''ÃÆ''¢📆'"),
        key="rubric_next_btn",
        use_container_width=True,
        type="secondary",
    ...
    if generate_btn:
        if not lieu_event.strip():
            ...
            with col_qr2:
                ...
                st.info("ÃÆ'Æ'ÆÃÆ'â€ ÃÆ'Æ''ÃÆ''Â°ÃÆ'Æ'Æ'...ÃÆ'Æ''ÃÆ''¸ÃÆ'Æ'ÆÃÆ'¢â'¬Ã...¡ÃÆ'Æ''ÃÆ''¡ **Conseil :** Imprimez ce code et fixez-le sur votre peson ou sur votre sac de collecte principal pour que chaque bénévole puisse flasher son impact en fin d'action.")

    st.markdown("---")
    st.subheader("💧ÃÆ'Æ'ÆÃÆ'¢â'¬Ã...¡ÃÆ'Æ''ÃÆ''¾ Templates imprimables & gestion multi-bénévoles")
...
if active == "gamification":
    ...
    with cg2:
        st.subheader("ÃÆ'Æ'ÆÃÆ'â€ ÃÆ'Æ''ÃÆ''Â°ÃÆ'Æ'Æ'...ÃÆ'Æ''ÃÆ''¸ÃÆ'Æ'ÆÃÆ'¢â'¬Ã...¡ÃÆ'Æ''ÃÆ''... Badges & Succès")
...
if active == "community":
    ...
    st.warning("ÃÆ'Æ'ÆÃÆ'â€ ÃÆ'Æ''ÃÆ''Â°ÃÆ'Æ'Æ'...ÃÆ'Æ''ÃÆ''¸ÃÆ'Æ'ÆÃÆ'¢â'¬Ã...¡ÃÆ'Æ''ÃÆ''¡ **Important** : Pour une organisation officielle et une visibilité maximale, nous vous recommandons vivement de créer également votre évènement sur [cleanwalk.org](https://www.cleanwalk.org), la plateforme de référence en France.")
...
if active == "sandbox":
    ...
    st.info("Cette zone est un bac à sable : vous pouvez ajouter des données fictives pour tester l'outil. Elles ne sont **pas enregistrées** dans la base réelle et seront perdues si vous rafraÃÆ'Æ'ÆÃÆ'â€ ÃÆ'Æ'â€ ÃÆ'Æ'ÆÃÆ'¢â'¬Ã...¡ÃÆ'Æ''ÃÆ''®chissez la page.")
...
if active == "declaration":
    ...
    st.divider()
    st.subheader("ÃÆ'Æ'ÆÃÆ'â€ ÃÆ'Æ''ÃÆ''Â°ÃÆ'Æ'Æ'...ÃÆ'Æ''ÃÆ''¸ÃÆ'Æ'ÆÃÆ'¢â'¬Ã...¡ÃÆ'Æ''ÃÆ''¡ Suggestions d'amélioration et signalement de bugs")
    st.write(
    ...
    st.divider()
    st.subheader("ÃÆ'Æ'ÆÃÆ'â€ ÃÆ'Æ''ÃÆ''Â°ÃÆ'Æ'Æ'...ÃÆ'Æ''ÃÆ''¸ÃÆ'Æ'ÆÃÆ'¢â'¬Ã...¡ÃÆ'Æ''ÃÆ''¬ Partagez votre exploit avec la communauté !")
...
if active == "route":
    ...
    if route_source_df.empty:
        ...
        st.markdown("### 💧ÃÆ'Æ'ÆÃÆ'¢â'¬Ã...¡ÃÆ'Æ''ÃÆ''­ Recommandation basee sur historique")
        ...
        with st.form("ai_route_form"):
            ...
            gen_btn = st.form_submit_button("ÃÆ'Æ'ÆÃÆ'â€ ÃÆ'Æ''ÃÆ''Â°ÃÆ'Æ'Æ'...ÃÆ'Æ''ÃÆ''¸ÃÆ'Æ'Æ'...ÃÆ'Æ''ÃÆ''½ Générer le parcours optimal", width="stretch")
        ...
        if gen_btn:
            with st.spinner("L'IA analyse les flux piétons et les points noirs de Paris..."):
                ...
                if result[0]:
                    ...
                    st.markdown("### ÃÆ'Æ'ÆÃÆ''¢ÃÆ'Æ'¢ÃÆ'¢â'¬Ã...¡ÃÆ''¬ÃÆ'Æ''ÃÆ''¹ Tableau de Bord Logistique (10 Équipes)")
                    ...
                    st.info(f"ÃÆ'Æ'ÆÃÆ'â€ ÃÆ'Æ''ÃÆ''Â°ÃÆ'Æ'Æ'...ÃÆ'Æ''ÃÆ''¸ÃÆ'Æ'ÆÃÆ'¢â'¬Ã...¡ÃÆ'Æ''ÃÆ''¡ **Conseil IA** : Les équipes 1 à 4 couvrent la montée, tandis que les équipes 5 à 8 couvrent le retour. Les équipes 9 et 10 sécurisent les abords. Restez groupés par binÃÆ'Æ'ÆÃÆ'â€ ÃÆ'Æ'â€ ÃÆ'Æ'ÆÃÆ'¢â'¬Ã...¡ÃÆ'Æ''ÃÆ''´mes !")
                    
                    st.success("ÃÆ'Æ'ÆÃÆ'â€ ÃÆ'Æ''ÃÆ''Â°ÃÆ'Æ'Æ'...ÃÆ'Æ''ÃÆ''¸ÃÆ'Æ'Æ'...ÃÆ'Æ''ÃÆ''½ÃÆ'Æ'ÆÃÆ'¢â'¬Ã...¡ÃÆ'Æ''ÃÆ''¯ **Étape Suivante** : Maintenant que vous avez votre itinéraire stratégique, officialisez votre action sur [cleanwalk.org](https://www.cleanwalk.org) pour recruter encore plus de bénévoles !")
                else:
...
if active == "recycling":
    ...
    if public_df.empty:
        ...
        with col_r2:
            st.metric(label="ÃÆ'Æ'ÆÃÆ'â€ ÃÆ'Æ''ÃÆ''Â°ÃÆ'Æ'Æ'...ÃÆ'Æ''ÃÆ''¸📍ÃÆ'Æ'ÆÃÆ'¢â'¬Ã...¡ÃÆ'Æ''ÃÆ''¾ Équivalent Bouteilles", value=f"{bouteilles_evitees:,}", help="1 kg de déchets équivaut environ au poids de 33 bouteilles plastiques de 1.5L.")
        with col_r3:
        ...
        st.markdown('<div class="premium-card animate-in">', unsafe_allow_html=True)
        st.markdown("### 💧ÃÆ'Æ'ÆÃÆ'¢â'¬Ã...¡ÃÆ'Æ''  Le Saviez-vous ?")
        ...
        with st.expander("ÃÆ'Æ'ÆÃÆ'â€ ÃÆ'Æ''ÃÆ''¢ÃÆ'Æ'Æ'...ÃÆ'Æ''ÃÆ''¡ÃÆ'Æ'ÆÃÆ'¢â'¬Ã...¡ÃÆ'Æ''ÃÆ''¡ Énergie Primaire vs Électricité"):
            st.write('''
        ...
        with st.expander("ÃÆ'Æ'Æ'...ÃÆ'Æ''  Qu'est-ce que l'ACV (Analyse du Cycle de Vie) ?"):
            ...
            5. **La Fin de vie**, oÃÆ'Æ'ÆÃÆ'â€ ÃÆ'Æ'â€ ÃÆ'Æ'ÆÃÆ'¢â'¬Ã...¡ÃÆ'Æ''ÃÆ''¹ les déchets deviennent de la pollution ou retournent dans la boucle matérielle via le recyclage.
            ''')
        ...
        with st.expander("💧 Microplastiques : Invisible et Universel"):
            ...
            Ces particules intègrent la chaÃÆ'Æ'ÆÃÆ'â€ ÃÆ'Æ'â€ ÃÆ'Æ'ÆÃÆ'¢â'¬Ã...¡ÃÆ'Æ''ÃÆ''®ne alimentaire. On estime que chaque humain ingère **l'équivalent d'une carte de crédit en plastique par semaine** (soit environ 5 grammes) via l'eau potable, le sel et l'alimentation.
            ''')

# ------------------------------------------------------------------------
# ONGLET : DÉRÃÆ'Æ'ÆÃÆ'â€ ÃÆ'Æ'â€ ÃÆ'Æ'ÆÃÆ'¢â'¬Â¹ÃÆ'Æ'¢ÃÆ'¢â€šÂ¬ GLEMENT CLIMATIQUE (EDUCATION)
# ------------------------------------------------------------------------
if active == "climate":
    render_tab_header(
        icon="\U0001F30D",
    ...
    with col_c1:
        ...
        st.write("""
        - **Origine humaine indiscutable :** Le réchauffement actuel (+1.1ÃÆ'Æ'ÆÃÆ'â€ ÃÆ'Æ'¢ÃÆ'¢â€šÂ¬ÃÆ'...¡ÃÆ'Æ'ÆÃÆ'¢â'¬Ã...¡ÃÆ'Æ''ÃÆ''°C depuis l'ère préindustrielle) est causé sans équivoque par les activités humaines (combustion d'énergies fossiles, déforestation).
        ...
        - **L'urgence d'agir :** Chaque fraction de degré compte. Limiter le réchauffement à 1.5ÃÆ'Æ'ÆÃÆ'â€ ÃÆ'Æ'¢ÃÆ'¢â€šÂ¬ÃÆ'...¡ÃÆ'Æ'ÆÃÆ'¢â'¬Ã...¡ÃÆ'Æ''ÃÆ''°C au lieu de 2ÃÆ'Æ'ÆÃÆ'â€ ÃÆ'Æ'¢ÃÆ'¢â€šÂ¬ÃÆ'...¡ÃÆ'Æ'ÆÃÆ'¢â'¬Ã...¡ÃÆ'Æ''ÃÆ''°C permet d'éviter des points de basculement irréversibles.
        """)
    ...
    with col_c2:
        ...
        st.write("""
        - **Objectif principal :** Maintenir l'augmentation de la température moyenne mondiale bien en dessous de 2ÃÆ'Æ'ÆÃÆ'â€ ÃÆ'Æ'¢ÃÆ'¢â€šÂ¬ÃÆ'...¡ÃÆ'Æ'ÆÃÆ'¢â'¬Ã...¡ÃÆ'Æ''ÃÆ''°C, et de préférence à 1.5ÃÆ'Æ'ÆÃÆ'â€ ÃÆ'Æ'¢ÃÆ'¢â€šÂ¬ÃÆ'...¡ÃÆ'Æ'ÆÃÆ'¢â'¬Ã...¡ÃÆ'Æ''ÃÆ''°C, par rapport aux niveaux préindustriels.
    ...
    st.markdown("### ÃÆ'Æ'ÆÃÆ'â€ ÃÆ'Æ''ÃÆ''Â°ÃÆ'Æ'Æ'...ÃÆ'Æ''ÃÆ''¸ÃÆ'Æ'Æ'...'ÃÆ'Æ'Æ'...ÃÆ'Æ''ÃÆ''½ Les 9 Limites Planétaires")
    ...
    with col_l1:
        ...
        2. ÃÆ'Æ'ÆÃÆ'¢â'¬Ã...¡ÃÆ'Æ''ÃÆ''´ L'érosion de la biodiversité
        3. ÃÆ'Æ'ÆÃÆ'¢â'¬Ã...¡ÃÆ'Æ''ÃÆ''´ La perturbation des cycles de l'azote et du phosphore
        4. ÃÆ'Æ'ÆÃÆ'¢â'¬Ã...¡ÃÆ'Æ''ÃÆ''´ Le changement d'usage des sols (déforestation)
        5. ÃÆ'Æ'ÆÃÆ'¢â'¬Ã...¡ÃÆ'Æ''ÃÆ''´ L'introduction d'entités nouvelles (pollutions chimiques, plastiques)
    ...
    st.markdown("---")
    st.info("ÃÆ'Æ'ÆÃÆ'â€ ÃÆ'Æ''ÃÆ''Â°ÃÆ'Æ'Æ'...ÃÆ'Æ''ÃÆ''¸ÃÆ'Æ'ÆÃÆ'¢â'¬Ã...¡ÃÆ'Æ''ÃÆ''¡ **Pour aller plus loin :** Pour approfondir ces sujets, n'hésitez pas à participer à une **Fresque du Climat**, un atelier ludique et collaboratif de 3h basé sur les rapports du GIEC, ou à consulter les rapports de l'ADEME.")
...
if active == "elus":
    ...
    if not approved_df.empty and 'adresse' in approved_df.columns:
        ...
        st.info("ÃÆ'Æ'ÆÃÆ'â€ ÃÆ'Æ''ÃÆ''Â°ÃÆ'Æ'Æ'...ÃÆ'Æ''ÃÆ''¸ÃÆ'Æ'ÆÃÆ'¢â'¬Ã...¡ÃÆ'Æ''ÃÆ''¡ Saisissez le nom de votre commune (ou un mot clé de votre territoire) pour isoler les statistiques.")
        ...
        if recherche_ville and recherche_ville != "-- Sélectionnez --":
            ...
            if df_ville.empty:
                ...
                col3.metric("économie estimée", f"{economie:.2f} €", help="coÃÆ'Æ'ÆÃÆ'â€ ÃÆ'Æ'â€ ÃÆ'Æ'ÆÃÆ'¢â'¬Ã...¡ÃÆ'Æ''ÃÆ''»t de traitement évité pour la collectivité.")
                ...
                if recherche_ville.lower() in [v.lower() for v in eligible_villes]:
                    st.success(f"ÃÆ'Æ'ÆÃÆ'â€ ÃÆ'Æ''ÃÆ''Â°ÃÆ'Æ'Æ'...ÃÆ'Æ''ÃÆ''¸ÃÆ'Æ'ÆÃÆ'¢â'¬Ã...¡ÃÆ'Æ''ÃÆ''... félicitations ! **{recherche_ville}** est labellisé **éco-quartier citoyen**.")
                    certif_eco = build_certificat_eco_quartier(recherche_ville)
                    st.download_button(
                        label=f"télécharger le diplÃÆ'Æ'ÆÃÆ'â€ ÃÆ'Æ'â€ ÃÆ'Æ'ÆÃÆ'¢â'¬Ã...¡ÃÆ'Æ''ÃÆ''´me éco-quartier ({recherche_ville})",
                        data=certif_eco,
                ...
                share_text = f"fier d'agir pour {recherche_ville} avec les brigades vertes ! déjà {tot_dechets:.1f}kg de déchets retirés. rejoignez-nous sur cleanwalk ÃÆ'Æ'ÆÃÆ'â€ ÃÆ'Æ''ÃÆ''Â°ÃÆ'Æ'Æ'...ÃÆ'Æ''ÃÆ''¸ÃÆ'Æ'Æ'...'ÃÆ'Æ'ÆÃÆ'¢â'¬Ã...¡ÃÆ'Æ''ÃÆ''¿"
                ...
                st.markdown("---")
                st.subheader("ÃÆ'Æ'ÆÃÆ'â€ ÃÆ'Æ''ÃÆ''Â°ÃÆ'Æ'Æ'...ÃÆ'Æ''ÃÆ''¸ÃÆ'Æ'ÆÃÆ'¢â'¬Ã...¡ÃÆ'Æ''ÃÆ''📆 Label Éco-Quartier Citoyen")
                ...
                if labels_eligibles:
                    st.success(f"ÃÆ'Æ'ÆÃÆ'â€ ÃÆ'Æ''ÃÆ''Â°ÃÆ'Æ'Æ'...ÃÆ'Æ''ÃÆ''¸ÃÆ'Æ'Æ'...'ÃÆ'Æ'Æ'...ÃÆ'Æ''ÃÆ''¸ Félicitations ! **{len(labels_eligibles)} zone(s)** de votre commune sont éligibles au Label Éco-Quartier (Zéro pollution sur 180 jours).")
                    ...
                    if selected_label:
                        ...
                        st.download_button(
                            label=f"ÃÆ'Æ'ÆÃÆ'â€ ÃÆ'Æ''ÃÆ''Â°ÃÆ'Æ'Æ'...ÃÆ'Æ''ÃÆ''¸ÃÆ'Æ'ÆÃÆ'¢â'¬Ã...¡ÃÆ'Æ''ÃÆ''Â¥ÃÆ'Æ'ÆÃÆ''¢ÃÆ'Æ'¢ÃÆ'¢â'¬Ã...¡ÃÆ''¬ÃÆ'Æ''ÃÆ''¡ Télécharger le Label pour '{selected_label}'",
                            data=certif_eco,
                            file_name=f"Label_EcoQuartier_{selected_label.replace(' ', '_')}.pdf",
                            mime="application/pdf"
                        )
                else:
                    st.info("Aucune zone n'a encore atteint le seuil des 180 jours de propreté continue avec signalements de contrÃÆ'Æ'ÆÃÆ'â€ ÃÆ'Æ'â€ ÃÆ'Æ'ÆÃÆ'¢â'¬Ã...¡ÃÆ'Æ''ÃÆ''´le. Encouragez vos citoyens à signaler les zones propres pour activer le label !")
...
if active == "weather":
    render_tab_header(
        ...
        subtitle_fr="Identifiez les meilleures fenetres météo pour planifier des opérations efficaces.",
    ...
    if df_cmp.empty:
        ...
        with c2c:
            sort_by = st.selectbox(
                "Trier par",
                ["Score IPC", "kg / action", "Mégots / bénévole", "Nombre d'actions", "kg / 10k habitants", "Mégots / kmÃÆ'Æ'ÆÃÆ'â€ ÃÆ'Æ'¢ÃÆ'¢â€šÂ¬ÃÆ'...¡ÃÆ'Æ'ÆÃÆ'¢â'¬Ã...¡ÃÆ'Æ''ÃÆ''²"],
                key="cmp_sort"
            )
        ...
        sort_map = {"Score IPC": "score_ipc", "kg / action": "kg_par_action",
                    ...
                    "kg / 10k habitants": "kg_par_10k_hab", "Mégots / kmÃÆ'Æ'ÆÃÆ'â€ ÃÆ'Æ'¢ÃÆ'¢â€šÂ¬ÃÆ'...¡ÃÆ'Æ'ÆÃÆ'¢â'¬Ã...¡ÃÆ'Æ''ÃÆ''²": "megots_par_km2"}
            ...
            <div style="background:{'linear-gradient(135deg,#f0fdf4,#ecfdf5)' if i < 3 else '#f8fafc'};
                ...
                <div style="display:flex;justify-content:space-between;align-items:center;">
                    ...
                    <div style="text-align:right;font-size:12px;color:#64748b;">
                        {int(row['nb_actions'])} actions ÃÆ'Æ'ÆÃÆ'â€ ÃÆ'Æ'¢ÃÆ'¢â€šÂ¬ÃÆ'...¡ÃÆ'Æ'ÆÃÆ'¢â'¬Ã...¡ÃÆ'Æ''ÃÆ''· {row['total_kg']:.1f} kg ÃÆ'Æ'ÆÃÆ'â€ ÃÆ'Æ'¢ÃÆ'¢â€šÂ¬ÃÆ'...¡ÃÆ'Æ'ÆÃÆ'¢â'¬Ã...¡ÃÆ'Æ''ÃÆ''· {int(row['total_megots']):,} mégots</div>
                </div>
