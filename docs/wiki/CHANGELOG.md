...
- **Validation**
  ...
  - Read/write probes: `app.py`, `README.md`, `docs/wiki/CHANGELOG.md` passed
...
- **What changed**
  ...
  - Added Python module entry support for scripts:
    - `scripts/__init__.py`
  - Migrated canonical baseline path to:
    - `docs/wiki/ui_inventory.baseline.json`
...
- **What changed**
  ...
  - Added baseline file: `docs/wiki/ui_inventory.baseline.json`.
  ...
  - Added tests for maintenance diagnostic behavior:
    - `tests/test_maintenance_service.py`.
  - Updated documentation in both `README.md` and wiki (`docs/wiki/MAINTENANCE.md`).
