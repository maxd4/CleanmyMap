...
def _rule_required_docs(root: Path) -> CleanupAuditRuleResult:
    ...
    if "scripts.ui_inventory" not in readme:
        missing_refs.append("README: reference à scripts.ui_inventory")
    ...
    if "UI_INVENTORY" not in wiki_index.upper():
        missing_refs.append("wiki index: lien UI_INVENTORY")
