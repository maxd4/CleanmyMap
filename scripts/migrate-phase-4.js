...
class Phase4Migration {
  constructor() {
    ...
    this.backupDir = path.join(__dirname, '../artifacts/backups/complex-form-backup')
  }
...
- **Composants archivés** dans \`artifacts/backups/complex-form-backup/\`
...
cp artifacts/backups/complex-form-backup/* src/components/actions/
\`\`\`
