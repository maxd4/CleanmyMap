 ...
 * Usage: node scripts/reports/generate-modularization-report.mjs <fichier-modularisé>
 */
...
export function main(args = process.argv.slice(2)) {
  if (args.length === 0) {
    console.error('Usage: node scripts/reports/generate-modularization-report.mjs <fichier-modularisé>');
    process.exit(1);
  }
