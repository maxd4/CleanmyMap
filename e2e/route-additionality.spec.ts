    ...
    await route.fulfill({
      ...
      body: JSON.stringify({
        ...
        trace: {
          ...
          budget: { requestedMinutes: 60, consumedMinutes: 6, remainingMinutes: 54 },
          distance: { totalKm: 0.8, segmentsTotalKm: 0.8 },
          duration: { networkMinutes: null, estimatedMinutes: 6, serviceMinutes: null, totalMinutes: 6 },
          routing: { provider: "none", profile: null, mode: "fallback", estimated: true, parameters: { walkingSpeedKmPerHour: 4.5, coordinateCount: 2, budgetPrefixApplied: false }, opaqueProviderDecisions: [], degradations: [] },
          segments: [], warnings: [], approximations: ["distance estimée"], fallbacks: [],
        ...
        routeGeometry: { coordinates: [[48.8566, 2.3522], [48.86, 2.35]], distanceKm: 0.8, durationMinutes: 6, legs: [], provider: "none", profile: null, mode: "fallback", estimated: true },
