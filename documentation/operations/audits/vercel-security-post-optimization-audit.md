...
| RPC `action_pollution_score_references_v2` | Conforme | La migration canonique définit `security invoker`, `set search_path = pg_catalog`, puis `grant execute ... to public`. La fonction ne renvoie que des agrégats sur `public.actions` et ne publie pas de données unitaires. |
...
- [apps/web/supabase/migrations/20260913000007_restore_pre77_pollution_score_contract.sql](../../../apps/web/supabase/migrations/20260913000007_restore_pre77_pollution_score_contract.sql)
...
- La RPC V2 de score carte reste publique parce qu'elle est read-only, invoker, et bornée à des agrégats.
