...
- the frontend normalizes each action against that reference in [`apps/web/src/lib/actions/pollution/pollution-score.ts`](../../apps/web/src/lib/actions/pollution/pollution-score.ts);
