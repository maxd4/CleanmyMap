...
- `apps/web/src/lib/accueil/config.ts` (configuration)
- `apps/web/src/components/accueil/index.ts` (exports)
...
1. Ajouter IMPACT_FACTORS et METRIC_EXPLANATIONS dans lib/accueil/config.ts
2. Créer un composant MetricTooltip.tsx avec les sources
3. Intégrer les tooltips dans accueil-impact-summary.tsx (icône info + hover)
...
**Solution** :
```typescript
// Dans accueil-impact-summary.tsx
<div
  role="region"
...
**Prompt à exécuter** :
```
Améliore l'accessibilité des métriques dans accueil-impact-summary.tsx :
...
1. Créer components/accueil/metric-gauge.tsx avec SVG + Framer Motion
...
1. Créer components/accueil/accueil-impact-map.tsx
...
1. Créer components/accueil/recent-actions-timeline.tsx
...
1. Créer components/accueil/recent-badges-showcase.tsx
