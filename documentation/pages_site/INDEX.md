...
| `/messagerie` | page de réseau | [Messagerie](./routes/04-reseau-discussions/messagerie/messagerie-README.md) | Réseau & Discussions (bloc) | protégé | Compte connecté, parfois rôle ou profil spécifique | pink | à corriger | apps/web/src/app/(app)/messagerie/page.tsx | ./routes/04-reseau-discussions/messagerie | non | fort | oui | critique |
...
| `/learn/hub` | page éducative | [Point de départ](./routes/05-apprendre/learn-hub/learn-hub-README.md) | Apprendre (bloc) | public | Aucun | yellow | à corriger | apps/web/src/app/learn/hub/page.tsx | ./routes/05-apprendre/learn-hub | non | fort | non | moyenne |
| `/learn/ressources` | page éducative | [Ressources](./routes/05-apprendre/learn-ressources/learn-ressources-README.md) | Apprendre (bloc) | public | Aucun | yellow | à corriger | apps/web/src/app/learn/ressources/page.tsx | ./routes/05-apprendre/learn-ressources | non | fort | non | moyenne |
...
| `/conditions-utilisation` | légale | [Conditions d'utilisation](./routes/07-legal/conditions-utilisation/conditions-utilisation-README.md) | Institutionnel & Légal (hors bloc) | légal | Aucun, page institutionnelle | slate / gris clair | à corriger | apps/web/src/app/conditions-utilisation/page.tsx | ./routes/07-legal/conditions-utilisation | non | fort | non | moyenne |
...
| `/en` | légale | [English entry](./routes/07-legal/en/en-README.md) | Institutionnel & Légal (hors bloc) | légal | Aucun, page institutionnelle | slate / gris clair | à corriger | apps/web/src/app/en/page.tsx | ./routes/07-legal/en | non | fort | non | moyenne |
...
| `/reglages` | outil | [Réglages](./routes/08-systeme-utilitaires/reglages/reglages-README.md) | Système & Utilitaires (hors bloc) | standalone | Accès direct depuis le shell ou un outil interne | slate / gris doux | à corriger | apps/web/src/app/reglages/page.tsx | ./routes/08-systeme-utilitaires/reglages | non | moyen | oui | critique |
