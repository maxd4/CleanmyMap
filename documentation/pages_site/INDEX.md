...
Ce document est la table de référence exhaustive de `documentation/pages_site`. Chaque route codée du repo y est inventoriée avec son statut, son contexte d'accès, son dossier canonique et ses signaux d'audit UI / contenu. La lecture suit la même taxonomie que le plan `PAGE_FAMILIES_PLAN.md`.

## Taxonomie des 11 types de routes

| # | Type de route | Dossier canonique | Rôle dans l’index |
|---|---|---|---|
| 00 | Homepage (hors bloc) | `routes/00-homepage` | famille autonome, hors bloc |
| 01 | Accueil & Pilotage (bloc) | `routes/01-accueil-pilotage` | famille bloc prioritaire |
...
- Les routes canoniques du bloc 01 sont centralisées côté code dans `apps/web/src/lib/accueil-pilotage-routes.ts`.
- La charte complémentaire des pages hors blocs vit dans `charte-pages-hors-blocs.md` ([lien](./charte-pages-hors-blocs.md)).

## Limites connues et solutions proposées

Les limites du modèle `page-families` sont documentées ici pour rester visibles dans l'index, avec la solution proposée pour chaque cas.

| Limite | Symptôme | Solution proposée |
|---|---|---|
| Coexistence de plusieurs systèmes couleur | `page-families`, `block-accents`, `RubriqueTheme`, `BLOCK_THEME`, classes Tailwind en dur | déprécier `block-accents`, mapper progressivement les thèmes vers `PageFamilyId`, garder `BLOCK_THEME` comme exception locale documentée |
| Cartes métier et layouts spécifiques | KPI pilotage, panneaux dashboard, cartes observatoire, grilles admin encore colorés en dur | ajouter des tokens `panel`, `kpi`, `stat` ou créer des wrappers dédiés, puis inventorier les routes concernées |
| Boutons et liens d’action | la logique des boutons reste partiellement pilotée par d’autres thèmes | étendre la famille avec des tokens bouton et vérifier la cohérence fond / carte / action principale |
| Sections dynamiques | la couleur peut dépendre du `sectionId`, pas seulement du pathname | passer un contexte de section à `resolvePageFamily` ou documenter des sous-familles explicites |
| Dérive des exceptions | la liste des overrides peut grossir sans gouvernance | limiter les exceptions par release et rattacher chaque exception à une fiche `pages_site` |
| Homepage et marketing | la homepage reste une famille séparée | maintenir la séparation volontaire entre homepage et bloc 01 et la documenter clairement |

Référence détaillée des arbitrages: [`PAGE_FAMILIES_PLAN.md`](./PAGE_FAMILIES_PLAN.md).
...
|---|---|---|---|---|---|---|---|---|---|:---:|---|:---:|---|
| `/` | homepage | [Page d'accueil](./routes/00-homepage/root/README.md) | Homepage (hors bloc) | public | Aucun | vert clair / emerald | à corriger | apps/web/src/app/page.tsx | ./routes/00-homepage/root | oui | moyen | non | faible |
| `/accueil` | redirection | [Accueil](./routes/00-homepage/accueil/README.md) | Homepage (hors bloc) | alias | Aucun | vert clair / emerald | hors scope | apps/web/src/app/accueil/page.tsx | ./routes/00-homepage/accueil | non | nul | non | faible |
...
| Route | Type de page | Fiche | Famille / hors bloc | Statut | Contexte d'accès | Palette attendue | Scope | Fichier source | Dossier canonique | Capture disponible | Surcharge textuelle | Incohérence couleur | Priorité |
|---|---|---|---|---|---|---|---|---|---|:---:|---|:---:|---|
| `/dashboard` | page de bloc | [Mon espace](./routes/01-accueil-pilotage/dashboard/README.md) | Accueil & Pilotage (bloc) | protégé | Compte connecté, parfois rôle ou profil spécifique | amber / orange / brun | terminé | apps/web/src/app/(app)/dashboard/page.tsx | ./routes/01-accueil-pilotage/dashboard | non | moyen | non | faible |
...
| `/parcours` | page d'action | [Parcours](./routes/01-accueil-pilotage/parcours/README.md) | Accueil & Pilotage (bloc) | protégé | Compte connecté, parfois rôle ou profil spécifique | amber / orange / brun | à valider | apps/web/src/app/(app)/parcours/page.tsx | ./routes/01-accueil-pilotage/parcours | non | moyen | non | critique |
| `/parcours/[profile] (ex. /parcours/benevole)` | dynamique — parcours | [Parcours par profil](./routes/01-accueil-pilotage/parcours-profile/README.md) | Accueil & Pilotage (bloc) | dynamique | Paramètre de route requis (profil, id, section, mission...) | amber / orange / brun | à valider | apps/web/src/app/(app)/parcours/[profile]/page.tsx | ./routes/01-accueil-pilotage/parcours-profile | non | moyen | non | moyenne |
| `/pilotage` | page de bloc | [Pilotage](./routes/01-accueil-pilotage/pilotage/README.md) | Accueil & Pilotage (bloc) | protégé | Compte connecté, parfois rôle ou profil spécifique | amber / orange / brun | à corriger | apps/web/src/app/(app)/pilotage/page.tsx | ./routes/01-accueil-pilotage/pilotage | non | fort | non | moyenne |
| `/profil` | redirection | [Profil](./routes/01-accueil-pilotage/profil/README.md) | Accueil & Pilotage (bloc) | redirection | Compte connecté, parfois rôle ou profil spécifique | amber / orange / brun | hors scope | apps/web/src/app/(app)/profil/page.tsx | ./routes/01-accueil-pilotage/profil | non | faible | non | faible |
| `/profil/[profile] (ex. /profil/benevole)` | dynamique — profil | [Profil détaillé](./routes/01-accueil-pilotage/profil-profile/README.md) | Accueil & Pilotage (bloc) | dynamique | Paramètre de route requis (profil, id, section, mission...) | amber / orange / brun | terminé | apps/web/src/app/(app)/profil/[profile]/page.tsx | ./routes/01-accueil-pilotage/profil-profile | non | moyen | non | faible |
| `/sponsor-portal` | page de bloc | [Portail décideur](./routes/01-accueil-pilotage/sponsor-portal/README.md) | Accueil & Pilotage (bloc) | protégé | Compte connecté, parfois rôle ou profil spécifique | amber / orange / brun | à corriger | apps/web/src/app/(app)/sponsor-portal/page.tsx | ./routes/01-accueil-pilotage/sponsor-portal | non | moyen | non | faible |

- Les entrées `/admin` et `/admin/godmode` sont exposées depuis le bloc 01 pour les profils autorisés; leur audit canonique reste dans la famille 09.
...
| `/signalement` | page d'action | [Signalement déchets](./routes/02-agir/signalement/README.md) | Agir (bloc) | protégé | Compte connecté, parfois rôle ou profil spécifique | emerald | terminé | apps/web/src/app/(app)/signalement/page.tsx | ./routes/02-agir/signalement | non | moyen | non | faible |
...
| `/methodologie` | rubrique cliquable — impact | [Méthodologie](./routes/03-cartographie-impact/methodologie/README.md) | Cartographie & Impact (bloc) | public | Aucun | red | terminé | apps/web/src/app/(app)/methodologie/page.tsx | ./routes/03-cartographie-impact/methodologie | non | moyen | non | faible |
| `/gamification` | page de bloc | [Progression & badges](./routes/03-cartographie-impact/gamification/README.md) | Cartographie & Impact (bloc) | protégé | Compte connecté, parfois rôle ou profil spécifique | red | à valider | apps/web/src/app/(app)/gamification/page.tsx | ./routes/03-cartographie-impact/gamification | non | moyen | non | critique |
| `/observatoire` | page de bloc | [Observatoire public](./routes/03-cartographie-impact/observatoire/README.md) | Cartographie & Impact (bloc) | protégé | Compte connecté, parfois rôle ou profil spécifique | sky | à valider | apps/web/src/app/(app)/observatoire/page.tsx | ./routes/03-cartographie-impact/observatoire | non | moyen | non | critique |
...
| `/sandbox` | page de bloc | [Sandbox carte](./routes/03-cartographie-impact/sandbox/README.md) | Cartographie & Impact (bloc) | protégé | Compte connecté, parfois rôle ou profil spécifique | sky | à valider | apps/web/src/app/(app)/sandbox/page.tsx | ./routes/03-cartographie-impact/sandbox | non | moyen | non | critique |
...
| Route | Type de page | Fiche | Famille / hors bloc | Statut | Contexte d'accès | Palette attendue | Scope | Fichier source | Dossier canonique | Capture disponible | Surcharge textuelle | Incohérence couleur | Priorité |
|---|---|---|---|---|---|---|---|---|---|:---:|---|:---:|---|
| `/community` | page de réseau | [Communauté](./routes/04-reseau-discussions/community/README.md) | Réseau & Discussions (bloc) | protégé | Compte connecté, parfois rôle ou profil spécifique | pink | à valider | apps/web/src/app/(app)/community/page.tsx | ./routes/04-reseau-discussions/community | non | fort | non | critique |
| `/sections/feedback` | rubrique cliquable — feedback | [Feedback](./routes/04-reseau-discussions/feedback/README.md) | Réseau & Discussions (bloc) | public | Aucun | pink | terminé | apps/web/src/app/(app)/sections/[sectionId]/page.tsx | ./routes/04-reseau-discussions/feedback | non | moyen | non | critique |
| `/messagerie` | page de réseau | [Messagerie](./routes/04-reseau-discussions/messagerie/README.md) | Réseau & Discussions (bloc) | protégé | Compte connecté, parfois rôle ou profil spécifique | pink | à valider | apps/web/src/app/(app)/messagerie/page.tsx | ./routes/04-reseau-discussions/messagerie | non | fort | non | critique |
| `/open-data` | page de réseau | [Open data](./routes/04-reseau-discussions/open-data/README.md) | Réseau & Discussions (bloc) | protégé | Compte connecté, parfois rôle ou profil spécifique | pink | à valider | apps/web/src/app/(app)/open-data/page.tsx | ./routes/04-reseau-discussions/open-data | non | moyen | non | critique |
...
| `/learn/hub` | page éducative | [Point de départ](./routes/05-apprendre/learn-hub/README.md) | Apprendre (bloc) | public | Aucun | yellow | à corriger | apps/web/src/app/learn/hub/page.tsx | ./routes/05-apprendre/learn-hub | non | faible | non | moyenne |
...
| Route | Type de page | Fiche | Famille / hors bloc | Statut | Contexte d'accès | Palette attendue | Scope | Fichier source | Dossier canonique | Capture disponible | Surcharge textuelle | Incohérence couleur | Priorité |
|---|---|---|---|---|---|---|---|---|---|:---:|---|:---:|---|
| `/onboarding` | onboarding | [Onboarding](./routes/06-auth-onboarding/onboarding/README.md) | Auth & Onboarding (hors bloc) | auth | Page d'entrée d'authentification ou de configuration initiale | lavande claire / vert menthe clair | terminé | apps/web/src/app/onboarding/page.tsx | ./routes/06-auth-onboarding/onboarding | oui | moyen | non | faible |
| `/onboarding/localisation` | redirection | [Onboarding localisation](./routes/06-auth-onboarding/onboarding-localisation/README.md) | Auth & Onboarding (hors bloc) | redirection | Ancienne route de compatibilité, redirigée vers `/onboarding` | lavande claire / vert menthe clair | hors scope | apps/web/src/app/onboarding/localisation/page.tsx | ./routes/06-auth-onboarding/onboarding-localisation | non | faible | non | faible |
| `/sign-in` | authentification | [Connexion](./routes/06-auth-onboarding/sign-in/README.md) | Auth & Onboarding (hors bloc) | auth | Page d'entrée d'authentification ou de configuration initiale | lavande claire / vert menthe clair | terminé | apps/web/src/app/sign-in/[[...sign-in]]/page.tsx | ./routes/06-auth-onboarding/sign-in | oui | faible | non | faible |
| `/sign-up` | authentification | [Inscription](./routes/06-auth-onboarding/sign-up/README.md) | Auth & Onboarding (hors bloc) | auth | Page d'entrée d'authentification ou de configuration initiale | lavande claire / vert menthe clair | terminé | apps/web/src/app/sign-up/[[...sign-up]]/page.tsx | ./routes/06-auth-onboarding/sign-up | oui | moyen | non | faible |
