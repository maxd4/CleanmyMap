...
| Route | Type de page | Fiche | Famille / hors bloc | Statut | Contexte d'accès | Palette attendue | Scope | Fichier source | Dossier canonique | Capture disponible | Surcharge textuelle | Incohérence couleur | Priorité |
|---|---|---|---|---|---|---|---|---|---|:---:|---|:---:|---|
| `/dashboard` | page de bloc | [Dashboard](./routes/01-accueil-pilotage/dashboard/README.md) | Accueil & Pilotage (bloc) | protégé | Compte connecté, parfois rôle ou profil spécifique | amber / orange / brun | terminé | apps/web/src/app/(app)/dashboard/page.tsx | ./routes/01-accueil-pilotage/dashboard | non | moyen | non | faible |
...
| `/profil` | page de bloc | [Profil](./routes/01-accueil-pilotage/profil/README.md) | Accueil & Pilotage (bloc) | protégé | Compte connecté, parfois rôle ou profil spécifique | amber / orange / brun | terminé | apps/web/src/app/(app)/profil/page.tsx | ./routes/01-accueil-pilotage/profil | non | moyen | non | faible |
...
| `/learn/hub` | page éducative | [Hub éducatif](./routes/05-apprendre/learn-hub/README.md) | Apprendre (bloc) | public | Aucun | yellow | à corriger | apps/web/src/app/learn/hub/page.tsx | ./routes/05-apprendre/learn-hub | non | fort | non | moyenne |
