...
**Référence complète** : `documentation/design-system/BLOC_COLOR_SYSTEM_PREMIUM.md` et `documentation/product/matrice-rubriques.md`
...
| `documentation/design-system/BLOC_COLOR_SYSTEM_PREMIUM.md` | Mapping rubrique → teinte (référence rapide) | Avant tout PROMPT d'implémentation |
