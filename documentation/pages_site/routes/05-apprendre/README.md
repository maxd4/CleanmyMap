...
| `/learn/hub` | [Hub léger](./learn-hub/README.md) | page éducative | public | à corriger | non | moyenne | apps/web/src/app/learn/hub/page.tsx |
...
- Le hub `/learn/hub` reste un point d'entrée léger: progression, reprise et accès directs. Le contenu détaillé vit dans les quatre autres rubriques.
