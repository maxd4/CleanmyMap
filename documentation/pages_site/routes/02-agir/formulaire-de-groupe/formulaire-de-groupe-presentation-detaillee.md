...
- **Rôle** : permettre de rejoindre une action de groupe validée, de consulter sa file publique, de suivre le statut des participations et de se retirer en cas d'erreur.
...
- **Bloc principal** : liste des actions validées, avec vignette visuelle, métadonnées, badges d'état et CTA `Demander à participer` ou `Quitter` selon l'état de participation.
