...
| `/sections/rejoindre-un-formulaire` | [Créer un formulaire](./formulaire-de-groupe/formulaire-de-groupe-README.md) | page de bloc | protégé | finalisée | non | faible | `apps/web/src/app/(app)/sections/[sectionId]/page.tsx` |
