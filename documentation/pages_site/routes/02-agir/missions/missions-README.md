...
- **Confidentialité** : La lecture mission/GPS n'utilise pas de cache partagé par identifiant de mission. Aucun partage public n'est prévu sans future vue sanitizée et contrat explicite ; l'ADR-004 sur l'identité compagnon reste un chantier distinct.
