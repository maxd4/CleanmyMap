...
|---|---|---|---|---|:---:|---|---|
| `/admin` | [Administration du site](./admin/README.md) | administration | technique | à corriger | non | moyenne | apps/web/src/app/(app)/admin/page.tsx |
...
| `/admin/godmode` | [Créateur du site](./admin-godmode/README.md) | administration | technique | à corriger | non | moyenne | apps/web/src/app/(app)/admin/godmode/page.tsx |
