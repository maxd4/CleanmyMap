...
| `/sections/messagerie` | [Groupes de discussion](./messagerie/messagerie-README.md) | section de réseau | protégé | à corriger | non | critique | `apps/web/src/app/(app)/sections/[sectionId]/page.tsx` |
...
| `/messagerie` | [Messagerie](./messagerie/messagerie-README.md) | redirection | hors scope | Alias technique vers `/sections/messagerie` |
...
- `/community`, `/messagerie` et `/open-data` restent des alias de compatibilité, la vérité métier passe par les sections canoniques.
