# Réseau & Discussions - PEPITE - Alias technique

## Fiche canonique

- **Route** : `/partners/network/pepite`
- **Fichier(s) source(s)** :
- `apps/web/src/app/(app)/partners/network/pepite/page.tsx`
...
- **Page cible** : `/sections/community?tab=partners`
- **Objectif utilisateur principal** : Rediriger vers l'onglet Partenaires de la communauté.
- **Action principale attendue** : Ouvrir la communauté partenaire.
...
- Le contenu visible reste la page cible communautaire partenaire.
