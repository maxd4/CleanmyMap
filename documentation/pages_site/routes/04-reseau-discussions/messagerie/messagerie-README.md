...
- **Navigation primaire** : les tabs `Canaux Publics` et `Messages privés` pilotent la surface affichée. En mode Messagerie, la navigation publique ne contient que Communauté, Territoire et leurs topics ; l’inbox DM porte seule la liste des conversations privées.
