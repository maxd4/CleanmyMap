...
## Parcours de lecture rapide {.unnumbered}
...
- [[7]](<https://blog.calif.io/p/first-public-kernel-memory-corruption>) Calif, *First public macOS kernel memory corruption exploit on M5 silicon*, 2026.
- [[8]](<https://security.apple.com/blog/memory-integrity-enforcement/>) Apple Security Research, *Memory Integrity Enforcement: A complete vision for memory safety in Apple platforms*, 2025.
- [[9]](https://www.tomshardware.com/tech-industry/cyber-security/apple-m5-architecture-suffers-first-privilege-escalation-exploit-anthropics-claude-mythos-helps-researchers-bypass-memory-integrity-enforcement) Tom’s Hardware, *First Apple M5 memory exploit discovered using Anthropic AI*, 2026.
