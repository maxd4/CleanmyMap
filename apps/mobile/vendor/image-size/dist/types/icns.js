...
function assertValidImageEntry(imageOffset, imageLength, fileLength, inputLength) {
    if (imageLength < 8 || imageOffset + imageLength > fileLength || imageOffset + imageLength > inputLength) {
...
exports.ICNS = {
    ...
    calculate(input) {
        ...
        assertValidImageEntry(imageOffset, imageHeader[1], fileLength, inputLength);
