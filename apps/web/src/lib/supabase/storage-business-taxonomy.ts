...
const STORAGE_BUSINESS_DOMAINS: StorageBusinessDomainRule[] = [
  ...
  },
  {
    ...
    bucketIds: ["action-photos", "photos", "photo-attachments", "attachments-images", "signalement-evidence"],
    pathPrefixes: ["photos/", "photo/", "attachments/photos/", "attachments/images/", "signalement-evidence/"],
