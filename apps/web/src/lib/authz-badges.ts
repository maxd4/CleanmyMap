...
const BADGE_CATALOG: Record<string, AccountBadge> = {
  ...
  role_coordinateur: { id: "role_coordinateur", label: "Association", icon: "target" },
  ...
  role_elu: { id: "role_elu", label: "Élu·e", icon: "badge-check" },
  role_max: { id: "role_max", label: "IMU", icon: "shield-check" },
  profile_admin: { id: "profile_admin", label: "Profil administrateur", icon: "shield" },
  profile_benevole: { id: "profile_benevole", label: "Profil bénévole", icon: "users" },
  profile_coordinateur: { id: "profile_coordinateur", label: "Profil Association", icon: "target" },
  ...
  profile_elu: { id: "profile_elu", label: "Profil Élu·e", icon: "badge-check" },
