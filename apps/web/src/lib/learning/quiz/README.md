...
La capacité scolaire autonome vit dans `apps/web/src/lib/learning/quiz/school/` : contrats de niveaux et formats, éligibilité par niveau, tracks internes, kit pédagogique, état `atelier-60` et tests scolaires associés. Son contrat est consommé par les moteurs génériques sans déplacer ces moteurs dans le sous-domaine scolaire.
