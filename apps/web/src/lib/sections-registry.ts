...
export const RUBRIQUE_REGISTRY = [
  ...
  },
  {
    ...
    kind: "app-route",
    route: "/explorer",
    label: { fr: "Explorer", en: "Explorer" },
    description: {
      fr: "Plan du site et accès direct aux rubriques",
      en: "Site map and direct access to sections",
    },
    availability: "available",
    implementation: "finalized",
  },
  ...
  },
  {
    ...
    label: { fr: "Carte d'entrainement", en: "Sandmap" },
    description: {
  ...
  },
  {
    ...
    label: { fr: "Guide compost", en: "Compost guide" },
    description: {
      fr: "Composter chez soi et en site local",
      en: "Compost at home and in local sites",
    },
    availability: "available",
    implementation: "finalized",
  },
  ...
  },
  {
    ...
    description: { fr: "Bonnes pratiques et workflow terrain", en: "Field workflow and best practices" },
    availability: "available",
    implementation: "finalized",
  },
  {
  ...
  },
  {
    ...
    description: {
      fr: "Signalements, améliorations et collaborations",
      en: "Reports, improvements and collaborations",
    },
    availability: "available",
    implementation: "finalized",
  },
  ...
  },
  {
    ...
    description: {
      fr: "Comprendre, s'entraîner, adopter de bonnes pratiques et retrouver les ressources utiles sur des pages dédiées",
      en: "Understand, practice, adopt best practices and find useful resources on dedicated pages",
    },
    availability: "available",
    implementation: "finalized",
  },
  {
    ...
    description: {
      ...
      en: "Scientific cues and orders of magnitude",
    },
    availability: "available",
    implementation: "finalized",
  },
  {
    ...
    description: {
      fr: "Quiz et rappel actif",
      en: "Quiz and active recall",
    },
    availability: "available",
    implementation: "finalized",
  },
  {
    ...
    description: {
      fr: "Gestes utiles et guides courts",
      en: "Useful gestures and short guides",
    },
    availability: "available",
    implementation: "finalized",
  },
  {
    ...
    description: {
      fr: "Kit, repères et événements",
      en: "Kit, references and events",
    },
    availability: "available",
    implementation: "finalized",
  },
