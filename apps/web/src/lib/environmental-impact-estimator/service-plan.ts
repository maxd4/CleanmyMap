...
const SERVICE_PLAN_INFO: Record<EnvironmentalImpactInfrastructureServiceKey, ServicePlanInfo> = {
  ...
  resend: {
    ...
    notes: [
      ...
      "Les emails envoyés et reçus comptent dans le quota transactionnel",
      "Les destinataires multiples comptent séparément",
      "Marketing: 1 000 contacts",
      "Marketing: broadcasts illimités vers les contacts existants",
    ],
  },
