      ...
      {profileOptions.length > 0 ? (
        <CmmDropdown
          ...
          renderTrigger={(triggerProps) => (
            ...
            <ChevronDown
              className={cn(
                "hidden h-4 w-4 shrink-0 text-slate-300 transition-transform duration-150 xl:inline",
