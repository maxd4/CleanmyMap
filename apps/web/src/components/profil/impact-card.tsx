    ...
    <div id="impact-card" className="relative w-full max-w-[400px] aspect-[4/5] bg-gradient-to-br from-emerald-600 to-emerald-900 text-white rounded-3xl p-8 shadow-2xl overflow-hidden">
      ...
      <header className="relative z-10 flex flex-col items-center gap-4 text-center">
        ...
        <div>
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/20 backdrop-blur-md rounded-full text-[10px] font-bold uppercase tracking-wider mt-2 border border-white/20">
      ...
      <section className="relative z-10 mt-10 grid grid-cols-2 gap-4">
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/10">
          <p className="text-[10px] uppercase font-bold text-emerald-200 tracking-widest">Poids collecté</p>
          <p className="text-2xl font-black mt-1">{totalKg.toFixed(1)}<span className="text-sm ml-1 opacity-60">kg</span></p>
        </div>
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/10">
          <p className="text-[10px] uppercase font-bold text-emerald-200 tracking-widest">Eau préservée</p>
          <p className="text-2xl font-black mt-1">{waterSaved.toLocaleString()}<span className="text-sm ml-1 opacity-60">L</span></p>
        </div>
        <div className="col-span-2 bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/10 flex items-center justify-between">
          <div>
            <p className="text-[10px] uppercase font-bold text-emerald-200 tracking-widest">Mégots extraits</p>
            <p className="text-2xl font-black mt-1">{totalButts.toLocaleString()}</p>
          </div>
