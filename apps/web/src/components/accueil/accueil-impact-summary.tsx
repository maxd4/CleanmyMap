...
export function HomeImpactSummary({
  ...
  if (!summary) {
    return (
      <section ref={rootRef} className="cmm-page-width relative z-20 -mt-12 px-4 sm:-mt-16 sm:px-8 lg:-mt-20 lg:px-12">
  ...
  const alertTone = severityTone(summary.alert.severity);
