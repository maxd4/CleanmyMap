...
"actions-map",
 ...
 <span className="rounded-full border border-white/15 bg-white/10 px-2.5 py-1 cmm-text-caption font-semibold uppercase tracking-[0.18em] text-white/70">
 Carte dominante
 </span>
 </div>
 <p className="mt-2 max-w-3xl cmm-text-small leading-6 text-slate-200 sm:text-[15px]">
 Flux géolocalisé depuis <code className="rounded bg-white/10 px-1.5 py-0.5 cmm-text-caption text-white">/api/actions/map</code> pour piloter les interventions terrain. La carte prend ici toute la place, tandis que la légende, les stats et les tableaux restent accessibles en second plan.
 </p>
 </div>
 <button
 onClick={() => void reload()}
 className="rounded-full border border-white/15 bg-white/10 px-4 py-2 cmm-text-small font-semibold text-white transition hover:bg-white/18"
 >
 ...
 <p className="cmm-text-small font-semibold uppercase tracking-[0.18em] text-rose-100">
 Carte indisponible
 </p>
 <p className="cmm-text-small leading-6 text-rose-50/90">
 {mapCanvasError}
 </p>
 </div>
 </div>
 ...
 <p className="cmm-text-small font-semibold uppercase tracking-[0.18em] text-slate-300">
 ...
 <p className="cmm-text-caption font-semibold uppercase tracking-[0.22em] text-slate-300">
 Légende dynamique d&apos;impact
 </p>
 <div className="mt-3 space-y-3">
 <div className="space-y-2">
 <div className="flex justify-between cmm-text-caption font-bold uppercase tracking-wider text-slate-300/90 px-1">
 <span>Faible</span>
 <span>Moyen</span>
 <span>Fort</span>
 <span>Critique</span>
 ...
 <div>
 <p className="cmm-text-caption font-bold uppercase tracking-wide text-white">Lieu propre</p>
 <p className="cmm-text-caption text-slate-300">Zone référencée sans pollution signalée.</p>
 </div>
 </div>
 <div className="flex items-center gap-3 rounded-2xl border border-white/10 bg-white/5 px-3 py-3">
 ...
 <div>
 <p className="cmm-text-caption font-bold uppercase tracking-wide text-white">Opacité dynamique</p>
 <p className="cmm-text-caption text-slate-300">Plus le score grimpe, plus la zone se détache.</p>
 </div>
 </div>
 </div>
 ...
 <p className="mt-2 cmm-text-small leading-6 text-slate-200">
 ...
 <p className="cmm-text-caption font-semibold uppercase tracking-wide text-emerald-100">Réel</p>
 <p className="mt-1 cmm-text-caption text-emerald-50/90">Trait plein</p>
 </div>
 <div className="rounded-2xl border border-amber-400/20 bg-amber-400/10 px-3 py-3">
 <p className="cmm-text-caption font-semibold uppercase tracking-wide text-amber-100">Estimé</p>
 <p className="mt-1 cmm-text-caption text-amber-50/90">Pointillé</p>
 </div>
 <div className="rounded-2xl border border-slate-500/20 bg-white/5 px-3 py-3">
 <p className="cmm-text-caption font-semibold uppercase tracking-wide text-slate-100">Fallback</p>
 <p className="mt-1 cmm-text-caption text-slate-300">Point discret</p>
 </div>
 </div>
 <div className="rounded-2xl border border-white/10 bg-white/5 px-3 py-3">
 <p className="cmm-text-caption font-semibold uppercase tracking-[0.18em] text-slate-300">
 Infrastructure recommandée
 </p>
 <p className="mt-2 cmm-text-caption leading-6 text-slate-300">
 ...
 <div className="mt-3 flex flex-wrap gap-2 cmm-text-caption font-semibold">
 ...
 <div className="space-y-2">
 <div className="flex justify-between cmm-text-caption font-bold uppercase tracking-wider cmm-text-muted px-1">
 <span>Faible</span>
 <span>Moyen</span>
 <span>Fort</span>
 <span>Critique</span>
 ...
 <div className="flex justify-between text-[9px] cmm-text-muted px-1">
 <span>Impact &lt; 30</span>
 <span>30 - 60</span>
 <span>60 - 80</span>
 <span>Score &gt; 80</span>
 ...
 <div>
 <p className="cmm-text-caption font-bold cmm-text-primary uppercase tracking-wide">Lieu Propre</p>
 <p className="cmm-text-caption cmm-text-muted">Zone référencée sans pollution signalée (Bleu fixe)</p>
 </div>
 </div>
 ...
 <div>
 <p className="cmm-text-caption font-bold cmm-text-primary uppercase tracking-wide">Opacité Dynamique</p>
 <p className="cmm-text-caption cmm-text-muted">Augmente avec le score pour isoler visuellement les urgences</p>
 </div>
 </div>
 </div>
 ...
 <span className="mt-0.5 inline-flex h-8 w-8 items-center justify-center rounded-full border border-emerald-200 bg-white cmm-text-caption font-bold text-emerald-700">
 —
 </span>
 <div>
 <p className="cmm-text-caption font-bold uppercase tracking-wide text-emerald-900">Réel</p>
 <p className="mt-1 cmm-text-caption leading-relaxed text-emerald-950/80">
 ...
 <span className="mt-0.5 inline-flex h-8 w-8 items-center justify-center rounded-full border border-amber-200 bg-white cmm-text-caption font-bold text-amber-700">
 - -
 </span>
 <div>
 <p className="cmm-text-caption font-bold uppercase tracking-wide text-amber-900">Estimé</p>
 <p className="mt-1 cmm-text-caption leading-relaxed text-amber-950/80">
 ...
 <span className="mt-0.5 inline-flex h-8 w-8 items-center justify-center rounded-full border border-slate-200 bg-white cmm-text-caption font-bold cmm-text-muted">
 •
 </span>
 <div>
 <p className="cmm-text-caption font-bold uppercase tracking-wide cmm-text-primary">Fallback</p>
 <p className="mt-1 cmm-text-caption leading-relaxed cmm-text-secondary">
 ...
 <p className="mt-2 cmm-text-caption text-emerald-950">
 ...
 <div>
 <p className="cmm-text-caption font-bold uppercase tracking-wide cmm-text-primary">Poubelle</p>
 <p className="mt-1 cmm-text-caption leading-relaxed cmm-text-secondary">
 ...
 <div>
 <p className="cmm-text-caption font-bold uppercase tracking-wide cmm-text-primary">Cendrier</p>
 <p className="mt-1 cmm-text-caption leading-relaxed cmm-text-secondary">
 ...
 <div>
 <p className="cmm-text-caption font-bold uppercase tracking-wide cmm-text-primary">Double achat</p>
 <p className="mt-1 cmm-text-caption leading-relaxed cmm-text-secondary">
