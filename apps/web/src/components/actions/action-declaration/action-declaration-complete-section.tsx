      ...
      <div className="md:col-span-2 rounded-lg border border-emerald-200 bg-emerald-50 p-4">
        ...
        {effectiveManualDrawingEnabled ? (
          <div className="mt-4 space-y-3">
            ...
            <p className="text-xs text-slate-700">
              {drawingIsValid
                ? `Dessin enregistre (${manualDrawing?.kind === "polygon" ? "polygone" : "trace"}, ${manualDrawing?.coordinates.length ?? 0} points).`
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <label className="flex flex-col gap-2 text-sm text-slate-700">
            ...
            >
              ...
              <option value="mouille">Mouill̩ (Satur̩ d&apos;eau, apr̬s pluie)</option>
            </select>
          </label>
        </div>
