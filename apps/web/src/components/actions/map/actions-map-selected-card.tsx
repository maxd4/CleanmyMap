...
export function ActionsMapSelectedCard({ item, onClear }: ActionsMapSelectedCardProps) {
  ...
  return (
    <section className="rounded-[2rem] border border-sky-200/80 bg-sky-50/95 p-5 shadow-[0_24px_56px_-32px_rgba(14,165,233,0.18)] backdrop-blur-xl">
      <div className="mb-4 flex items-start justify-between gap-4">
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            <span className="inline-flex h-8 w-8 items-center justify-center rounded-2xl bg-sky-200 text-slate-950 ring-1 ring-inset ring-sky-300/18">
              <Layers3 size={16} />
            </span>
            <div>
              ...
              <p className="text-xs font-medium text-slate-600">
                Résumé compact de l&apos;action sélectionnée
              </p>
            </div>
          </div>
          <div>
        ...
        <button
          type="button"
          onClick={onClear}
          className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-sky-200/80 bg-sky-100 text-slate-950 shadow-[0_10px_28px_-18px_rgba(14,165,233,0.16)] transition hover:border-sky-300 hover:bg-sky-200 hover:text-slate-950"
      ...
      <div className="mt-4 grid grid-cols-2 gap-3">
        <div className="rounded-2xl border border-sky-200/80 bg-white p-3">
      ...
      <div className="mt-4 rounded-2xl border border-sky-200/80 bg-gradient-to-br from-sky-50 to-sky-100 p-3">
