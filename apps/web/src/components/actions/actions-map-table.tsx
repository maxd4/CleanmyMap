...
if (items.length === 0) {
 return (
 <section className={`rounded-2xl border border-sky-200/80 bg-sky-50/95 shadow-[0_18px_44px_-30px_rgba(14,165,233,0.16)] ${compact ?"p-4" :"p-6"}`}>
 ...
 return (
 <section className={`rounded-2xl border border-sky-200/80 bg-sky-50/95 shadow-[0_18px_44px_-30px_rgba(14,165,233,0.18)] ${compact ?"p-4" :"p-6"}`}>
 <div className={`flex items-center justify-between ${compact ?"mb-3" :"mb-4"}`}>
 <h2 className={compact ?"text-lg font-semibold text-slate-950" :"text-xl font-semibold text-slate-950"}>Journal des actions</h2>
 <span className="rounded-full border border-sky-200/80 bg-white px-2.5 py-1 cmm-text-caption font-medium text-slate-700">
 {items.length} points
 </span>
 </div>
