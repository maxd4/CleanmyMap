...
export function OpenDataSection() {
 ...
 <div className="rounded-xl border border-cyan-200 bg-cyan-50 p-4 cmm-text-small text-cyan-900">
 {fr
 ...
 <section className="rounded-xl border border-slate-200 bg-white p-4">
 <h3 className="cmm-text-small font-semibold cmm-text-primary">{fr ?"API et accès chercheurs" :"API and researcher access"}</h3>
