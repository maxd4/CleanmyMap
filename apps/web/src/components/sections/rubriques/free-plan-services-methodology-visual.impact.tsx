...
import { Cloud, ExternalLink, Leaf, MoreHorizontal, Sparkles } from "lucide-react";
...
const MAX_TOP_PRODUCTION_SERVICES = 6;
const MIN_IMPACT_SEGMENT_LABEL_PERCENT = 7;
...
type ImpactViewProps = {
  ...
  onSelectImpact: (key: ImpactSelectionKey | null) => void;
};

export function FreePlanServicesMethodologyImpactView({
  services,
  impactTotals,
  isFrench,
  sectionId,
  ...
  const resolvedImpactTotals = impactTotals;
    ...
    const topProductionServices = activeProductionImpactServices.slice(0, MAX_TOP_PRODUCTION_SERVICES);
    ...
    const topContributors = activeProductionImpactServices.slice(0, MAX_TOP_PRODUCTION_SERVICES);
                  ...
                  barSegments.map((segment) => {
                    ...
                    return (
                      <button
                        ...
                        key={segment.key}
                        className={cn(
                          "flex min-w-[92px] flex-1 flex-col items-center gap-2 rounded-[1.2rem] px-2 py-2 text-center transition focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-rose-500",
                        ...
                        onClick={() => onSelectImpact(segment.key)}
                  ...
                  <div className="flex h-14 overflow-hidden">
                    {barSegments.map((segment) => {
                      ...
                      return (
                        ...
                        >
                          {segment.sharePercent !== null && segment.sharePercent >= MIN_IMPACT_SEGMENT_LABEL_PERCENT ? (
                            <span
                              className={cn(
                  ...
                  <div className="space-y-4">
                    <div className="flex flex-wrap items-start justify-between gap-4">
                      ...
                      <button
                        ...
                        className="inline-flex items-center gap-2 rounded-full border border-rose-200 bg-white px-4 py-2 text-[11px] font-black uppercase tracking-[0.18em] text-rose-700 transition hover:bg-rose-100 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-rose-500"
                      >
