...
export function SectionShell(props: {
 ...
 {props.traceNote ? (
 <div className="rounded-xl border border-amber-200 bg-white/90 px-3 py-2 cmm-text-caption cmm-text-secondary">
 {props.traceNote}
 </div>
 ) : null}
 </div>
...
export function PendingSection(props: {
 ...
 <p className="mt-2 cmm-text-small font-medium text-amber-900">
 {locale ==="fr" ?"But de la rubrique" :"Section purpose"}
 </p>
 <p className="mt-1 cmm-text-small text-amber-800">{t(locale, props.description)}</p>
