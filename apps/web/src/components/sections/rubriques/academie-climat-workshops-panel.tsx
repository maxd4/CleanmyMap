    ...
    <section className="space-y-4 rounded-3xl border border-slate-200 bg-white/95 p-5 shadow-md">
      <div className="flex flex-wrap items-start justify-between gap-3">
        ...
        <div className="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-2 text-xs text-slate-700">
          ...
          <p className="mt-1 text-lg font-black text-slate-950">{totalWorkshops}</p>
        </div>
      </div>
        ...
        {visibleCategories.map((category) => (
          ...
          >
            <div className="flex flex-wrap items-center justify-between gap-2">
              ...
              <span className="rounded-full border border-current/15 bg-white/60 px-3 py-1 text-[11px] font-semibold">
                ...
                >
                  <div className="flex flex-wrap items-start justify-between gap-3">
                    ...
                    <Link
                      ...
                      className="shrink-0 rounded-full border border-slate-200 bg-white px-3 py-1.5 text-xs font-semibold text-slate-700 transition hover:border-emerald-200 hover:bg-emerald-50 hover:text-emerald-800"
                    >
