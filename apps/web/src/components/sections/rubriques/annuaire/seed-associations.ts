...
const ASSOCIATIONS_BASE_ENTRIES: AnnuaireEntry[] = [
  ...
  },
  {
    ...
    types: ["social"],
    isFeatured: true,
    featuredReason: "Réseau national de référence pour l'entrepreneuriat étudiant, avec un ancrage local à Sorbonne Université.",
    description:
    ...
    associationProfile: {
      ...
      recurringNeeds: ["Relais de communication", "Bénévoles d'accueil"],
      pastActions: [
        "Accompagnement de projets étudiants et jeunes diplômés",
        "Ancrage local avec Sorbonne Université",
        "Mise en lien avec des dispositifs nationaux de l'entrepreneuriat étudiant",
      ],
      usefulResources: [
        {
