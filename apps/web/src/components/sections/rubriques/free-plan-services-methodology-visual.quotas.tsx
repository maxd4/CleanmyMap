...
type DisplayedService = ReturnType<
...
type Props = {
  ...
  selectedKey: QuotaDisplayServiceKey;
  onSelect: (key: QuotaDisplayServiceKey) => void;
  hoveredKey: QuotaDisplayServiceKey | null;
  onHover: (key: QuotaDisplayServiceKey | null) => void;
};

export function FreePlanServicesMethodologyVisualQuotas({
  displayedServices,
  githubStats,
  isFrench,
  activeTab,
