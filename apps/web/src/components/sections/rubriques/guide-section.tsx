...
"cleanmymap.guide.checklist",
 ...
 className="rounded-lg border border-slate-300 px-2 py-1 cmm-text-caption outline-none transition focus:border-emerald-500"
 >
 ...
 <p className="mt-1 cmm-text-small cmm-text-secondary">{step.content}</p>
 </article>
 ))}
 </div>
 ...
 <Link
 href="/actions/new"
 className="rounded-lg border border-emerald-300 bg-emerald-50 px-3 py-2 cmm-text-caption font-semibold text-emerald-800 transition hover:bg-emerald-100"
 >
 ...
 <article className="rounded-3xl border border-slate-200 bg-slate-50/80 p-4 cmm-text-small cmm-text-secondary shadow-sm">
 <div className="flex flex-wrap items-center justify-between gap-2">
 <p className="font-semibold cmm-text-primary">
 {fr ?"Mode opératoire bénévole (web)" :"Volunteer playbook (web)"}
 </p>
 <p className="cmm-text-caption font-semibold uppercase tracking-wide text-emerald-700">
 ...
 />
 <span className="font-medium cmm-text-primary">
 {fr
