        ...
        <div className="flex flex-wrap gap-2 relative z-10">
          {QUICK_PROMPTS[locale].slice(0, 3).map((item) => (
            <CmmButton
              ...
              tone="tertiary"
              variant="pill"
              className="rounded-xl px-4 py-2 text-[11px] font-black uppercase tracking-widest text-slate-400 hover:border-emerald-500/30 hover:bg-emerald-500/10 hover:text-emerald-400"
            >
              {item}
            </CmmButton>
          ))}
