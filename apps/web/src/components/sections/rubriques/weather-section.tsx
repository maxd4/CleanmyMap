  ...
  const data = [
    {
      ...
      value: isWeatherReady
        ? currentRisk!.equipment.join(" • ")
        : fr
          ? "Gants • Sacs • Pinces • Eau"
          : "Gloves • Bags • Pliers • Water",
      tone: "emerald",
    },
    {
      ...
      value: isWeatherReady ? getVolunteersRange(currentRisk!.level) : fr ? "À définir" : "To define",
      note: fr ? "fourchette recommandée" : "recommended range",
      tone: "amber",
    },
    {
      label: fr ? "Durée prévue" : "Planned duration",
      value: isWeatherReady ? getDurationLabel(currentRisk!.level) : fr ? "À ajuster" : "To adjust",
      note: fr ? "selon météo et sécurité" : "based on weather and safety",
      tone: "blue",
    },
    {
      label: fr ? "Accessibilité" : "Accessibility",
      value: selectedLocationSubtitle || selectedLocationLabel,
    ...
    },
    {
      ...
      value: isWeatherReady
        ? currentRisk!.constraints.join(" • ")
        : fr
          ? "Évite les déchets dangereux • Garde les binômes"
          : "Avoid hazardous waste • Work in pairs",
