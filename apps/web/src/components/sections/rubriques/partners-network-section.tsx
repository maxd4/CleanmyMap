...
import { ArrowRight, Handshake, LayoutDashboard, Network, Search, UserPlus, Users } from "lucide-react";
...
export function PartnersNetworkSection({ fr }: { fr: boolean }) {
  ...
  const networkActions: NavigationGridItem[] = [
    {
      ...
      desc: fr
        ? "Parcourir les structures et repérer les acteurs utiles."
        : "Browse structures and spot the relevant actors.",
    ...
    },
    {
      ...
      desc: fr
        ? "Proposer votre structure et devenir visible."
        : "Submit your structure and become visible.",
      iconBg: "bg-indigo-400/16",
      iconColor: "text-indigo-50",
    ...
    },
    {
      ...
      desc: fr
        ? "Contrôler les fiches et suivre les demandes."
        : "Review profiles and track requests.",
      iconBg: "bg-indigo-400/16",
      iconColor: "text-indigo-50",
      accent: "from-[rgba(22,26,72,0.96)] to-[rgba(67,56,202,0.94)]",
      ring: "ring-indigo-300/18",
    ...
    },
    {
      ...
      desc: fr
        ? "Basculer vers le sponsor portal."
  ...
  return (
    <div className="space-y-8 text-white">
        ...
        <div className="relative z-10 grid gap-8 xl:grid-cols-[1.1fr_0.9fr] xl:items-end">
          <div className="space-y-6">
            <PageHeader
              tone="indigo"
              contrast="inverse"
              eyebrow={fr ? "Partenaires" : "Partners"}
              ...
              subtitle={fr
                ? "Les partenaires restent accessibles dans la même page que la vie de la communauté, mais avec leur propre onglet."
                : "Partners stay on the same page as community life, with their own tab."}
              badges={
                <>
      ...
      <section className="rounded-[3rem] border border-violet-300/16 bg-[rgba(28,20,58,0.9)] p-6 shadow-[0_24px_56px_-32px_rgba(139,92,246,0.24)] sm:p-10 lg:p-12">
        <div className="grid gap-8 xl:grid-cols-[1.1fr_0.9fr] xl:items-start">
          <div className="space-y-5">
            ...
            <p className="max-w-2xl text-sm leading-relaxed text-violet-100/68 sm:text-base">
              {fr
                ? "Le réseau relie les acteurs aux territoires et aux canaux de contact. L'onglet partenaires sert de lecture détaillée, tandis que la vie de la communauté reste sur le même écran."
                : "The network links actors to territories and contact channels. The partners tab is the detailed reading layer while community life stays on the same screen."}
            </p>
          </div>
      ...
      <footer className="cmm-ribbon-surface rounded-[3rem] p-6 sm:p-10">
