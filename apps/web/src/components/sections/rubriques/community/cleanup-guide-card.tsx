...
const STEPS = [
  {
    ...
    desc: "Privilégier un week-end, éviter les jours feriés. Prévoir 2-3 semaines de communication et un rappel sécurité.",
    tips: ["Vérifier la météo", "Choisir un créneau de 2-3h", "Préparer le message de rappel"],
  },
  {
    id: 2,
    icon: MapPin,
  ...
  },
  {
    ...
    desc: "Constituer un noyau de bénévoles motivés. Solliciter partenaires locaux (associations, entreprises) et nommer un binôme sécurité.",
  ...
  },
  {
    ...
    desc: "Gants, sacs poubelle, pinces, gilets, trousse de premiers secours et repères de tri.",
    tips: ["Prévoir 2 sacs par personne", "Pinces anti-coupure", "Eau et en-cas", "Poubelles adaptées"],
  },
  {
    id: 5,
    icon: Megaphone,
    title: "Communiquer",
    desc: "Diffuser l'événement sur les réseaux sociaux, flyers, bouche-à-oreille et rappeler la conduite attendue.",
  ...
  },
  {
    ...
    desc: "Prévoir le rapatriement des sacs vers un point de collecte ou déchetterie et le tri final.",
