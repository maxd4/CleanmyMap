    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
        <label className="space-y-1">
          <span className="text-xs font-semibold text-slate-700">Nom de la structure</span>
          <input
            required
      ...
      <label className="block space-y-1">
        <span className="text-xs font-semibold text-slate-700">Identité légale ou associative</span>
        <input
          required
          value={legalIdentity}
      ...
      <section className="space-y-3 rounded-xl border border-slate-200 bg-slate-50 p-4">
        <div>
          <h3 className="text-sm font-semibold text-slate-900">Périmètre géographique</h3>
            ...
            <div className="flex flex-wrap gap-2">
              {coverage.quartiers.map((quartier) => (
                <button
                  ...
                  className="rounded-full border border-emerald-200 bg-emerald-50 px-3 py-2 text-xs font-semibold text-emerald-800 hover:bg-emerald-100"
                >
                  {quartier} ×
                </button>
              ))}
      ...
      <section className="space-y-3 rounded-xl border border-slate-200 bg-slate-50 p-4">
        ...
        <div className="space-y-3">
          {availabilitySlots.map((slot, index) => (
            ...
            >
              <label className="space-y-1">
                <span className="text-[11px] font-semibold text-slate-700">Jour</span>
                <select
                  value={slot.day}
                  onChange={(event) =>
              ...
              <label className="space-y-1">
                <span className="text-[11px] font-semibold text-slate-700">Début</span>
                <input
                  type="time"
                  value={slot.start}
              ...
              <label className="space-y-1">
                <span className="text-[11px] font-semibold text-slate-700">Fin</span>
                <input
                  type="time"
                  value={slot.end}
              ...
              <div className="flex items-end">
                <button
                  ...
                  className="w-full rounded-lg border border-rose-200 bg-white px-3 py-2 text-sm font-semibold text-rose-700 hover:bg-rose-50 disabled:cursor-not-allowed disabled:opacity-50"
                >
                  Supprimer
                </button>
              </div>
        ...
        <label className="block space-y-1">
          <span className="text-xs font-semibold text-slate-700">Précisions éventuelles</span>
          <textarea
      ...
      <div className="grid grid-cols-1 gap-3 md:grid-cols-3">
        ...
        <label className="space-y-1 md:col-span-1">
          <span className="text-xs font-semibold text-slate-700">Canal de contact</span>
          <input
            required
        ...
        <label className="space-y-1 md:col-span-1">
          <span className="text-xs font-semibold text-slate-700">Coordonnée joignable</span>
          <input
            required
      ...
      >
        {isSubmitting ? "Envoi en cours..." : "Envoyer à l'administration"}
      </button>
    </form>
  );
}
