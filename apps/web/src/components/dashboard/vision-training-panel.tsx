...
export function VisionTrainingPanel({ metrics }: VisionTrainingPanelProps) {
    ...
    <section className="space-y-4 rounded-2xl border border-white/40 bg-white/60 backdrop-blur-md p-5 shadow-xl">
      <div>
        ...
        <p className="mt-1 cmm-text-small cmm-text-secondary">
          {paused
            ? "L'apprentissage vision est en pause: les nouvelles photos restent compressées pour la déclaration, mais ne nourrissent plus le modèle pour l'instant."
 ...
 <p className="cmm-text-caption uppercase tracking-wide cmm-text-muted">Exemples</p>
 <p className="mt-1 text-lg font-semibold cmm-text-primary">
 {metrics?.count ?? 0}
 </p>
 </article>
 <article className="rounded-xl border border-slate-200 bg-slate-50 p-3">
 <p className="cmm-text-caption uppercase tracking-wide cmm-text-muted">Labellisés</p>
 <p className="mt-1 text-lg font-semibold cmm-text-primary">
 {metrics?.labelledCount ?? 0}
 </p>
 </article>
 <article className="rounded-xl border border-slate-200 bg-slate-50 p-3">
 <p className="cmm-text-caption uppercase tracking-wide cmm-text-muted">MAE</p>
 <p className="mt-1 text-lg font-semibold cmm-text-primary">
 {formatMetric(metrics?.mae ?? null)} kg
 </p>
 </article>
 <article className="rounded-xl border border-slate-200 bg-slate-50 p-3">
 <p className="cmm-text-caption uppercase tracking-wide cmm-text-muted">RMSE</p>
 <p className="mt-1 text-lg font-semibold cmm-text-primary">
 ...
 <div className="flex flex-wrap items-center gap-2 cmm-text-caption cmm-text-secondary">
        ...
        >
          {paused ? "Apprentissage en pause" : "Apprentissage actif"}
        </span>
        <span
          className={`rounded-full px-2 py-1 font-semibold ${
            lowData
 ...
 <div className="grid gap-2 md:grid-cols-4 cmm-text-caption cmm-text-secondary">
