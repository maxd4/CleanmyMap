...
export function ReportExportSmokeCard() {
 ...
 <h2 className="text-base font-semibold cmm-text-primary">Reporting</h2>
 ...
 className="rounded-lg border border-slate-300 bg-white px-3 py-2 cmm-text-small font-semibold cmm-text-secondary transition hover:bg-slate-100 disabled:cursor-not-allowed disabled:bg-slate-50"
 >
 {probeState ==="pending"
 ?"Test en cours..."
 :"Tester l'export CSV"}
 ...
 <p className="mt-3 rounded-lg border border-rose-200 bg-rose-50 px-3 py-2 cmm-text-small text-rose-700">
 {message}
 </p>
 ) : null}
 </article>
