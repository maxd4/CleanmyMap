...
"idle",
 ...
 <p className="mt-1 text-lg font-semibold cmm-text-primary">{kpi.value}</p>
 </article>
 ))}
 </div>

 <article className="rounded-xl border border-emerald-200 bg-emerald-50 p-3 cmm-text-small text-emerald-900">
 ...
 className="mt-2 inline-flex rounded-lg border border-emerald-300 bg-white px-3 py-2 cmm-text-caption font-semibold text-emerald-900 hover:bg-emerald-100"
 >
 ...
 <label className="block cmm-text-caption font-semibold uppercase tracking-wide cmm-text-secondary">
 ...
 type="submit"
 disabled={!canSubmit}
 className="rounded-lg bg-slate-900 px-3 py-2 cmm-text-caption font-semibold text-white hover:bg-slate-800 disabled:cursor-not-allowed disabled:opacity-60"
 >
