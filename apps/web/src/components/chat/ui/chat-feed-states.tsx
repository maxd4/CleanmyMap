...
export function ChatEmptyState({
  ...
  const isLight = tone === "light";
  const isUnselectedDm = activeChannelType === "dm" && !selectedRecipientId;
  const showStarterPrompts = isAuthenticated && !isUnselectedDm;
  ...
  const description = !isAuthenticated
    ? activeChannelType === "dm"
      ...
      : "Vous consultez cette discussion en mode invité. Connectez-vous pour participer à la discussion."
