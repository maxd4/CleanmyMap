...
export function SitePreferencesControls({
  ...
  if (variant === "locale") {
    ...
    return (
      <button
        ...
        className="inline-flex items-center gap-2 rounded-full border border-cyan-200/80 bg-white/90 px-4 py-2 text-[11px] font-black uppercase tracking-[0.18em] text-slate-700 shadow-sm shadow-cyan-950/10 transition hover:border-cyan-300 hover:bg-cyan-50/80 dark:border-cyan-400/30 dark:bg-slate-900/85 dark:text-slate-200 dark:hover:bg-slate-800"
  ...
  return (
    <div className="space-y-2">
      <p className="px-1 text-[10px] font-black uppercase tracking-[0.2em] text-slate-500">
      ...
      <div className="relative group">
        ...
        <select
          ...
          className="cursor-pointer appearance-none rounded-xl bg-transparent px-2 py-1.5 pl-7 text-[11px] font-bold text-slate-600 transition-colors hover:bg-white dark:text-slate-300 dark:hover:bg-slate-700/80 focus:outline-none"
      ...
      <button
        type="button"
        onClick={toggleTheme}
        className="flex items-center gap-2 rounded-xl px-2 py-1.5 text-[11px] font-bold text-slate-600 transition-colors hover:bg-white dark:text-slate-300 dark:hover:bg-slate-700/80"
