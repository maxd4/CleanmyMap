...
export function IdentityProfileBanner({ profile }: IdentityProfileBannerProps) {
 ...
 <p className="cmm-text-caption font-bold uppercase tracking-[0.2em] cmm-text-muted">Expérience de navigation</p>
 <p className="cmm-text-small font-bold cmm-text-primary leading-tight mt-1">
