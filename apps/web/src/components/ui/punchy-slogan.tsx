      ...
      <header className="mb-4 mt-2 px-2 border-l-4 border-emerald-500 pl-6">
        <div className="flex items-center gap-2 whitespace-nowrap overflow-x-auto scrollbar-none">
          {words.map((word, index) => (
            <span
              key={word}
              className="text-3xl font-black leading-none tracking-tighter text-slate-900 md:text-5xl"
            >
              {word}
      ...
      >
        {words.map((word, i) => (
          <motion.span
            ...
            className="text-3xl font-black leading-none tracking-tighter text-emerald-950 sm:text-5xl md:text-6xl"
            style={{
