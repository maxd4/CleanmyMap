...
export const NAVIGATION_DROPDOWN_SHELL_CLASS_NAME =
  "absolute left-1/2 z-50 mt-2 w-[min(27rem,calc(100vw-1.5rem))] overflow-hidden rounded-[1.5rem] border text-black shadow-[0_24px_52px_-26px_rgba(15,23,42,0.16)]";
...
export const NAVIGATION_DROPDOWN_TREE_ITEM_LABEL_CLASS_NAME =
  "block cmm-text-small font-semibold text-black";

export const NAVIGATION_DROPDOWN_TREE_SECTION_CLASS_NAME =
  "rounded-[1.2rem] border bg-white/45 p-1.5";

export const NAVIGATION_DROPDOWN_TREE_SECTION_ACTIVE_CLASS_NAME =
  "border-black/18 bg-white/65";

export const NAVIGATION_DROPDOWN_TREE_SECTION_CURRENT_CLASS_NAME =
  "border-black/16 bg-white/55";

export const NAVIGATION_DROPDOWN_TREE_SECTION_INACTIVE_CLASS_NAME =
  "border-black/10";

export const NAVIGATION_DROPDOWN_TREE_PANEL_INNER_CLASS_NAME =
  "overflow-hidden";

export const NAVIGATION_DROPDOWN_TREE_LIST_CLASS_NAME =
  "mt-1.5 space-y-1 px-1 pb-1";

export const NAVIGATION_DROPDOWN_TREE_ITEM_CARD_CLASS_NAME =
...
export const NAVIGATION_DROPDOWN_TREE_ITEM_ACTIVE_CLASS_NAME =
