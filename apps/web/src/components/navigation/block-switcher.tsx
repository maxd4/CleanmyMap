      ...
      <div className="border-t border-slate-200/80 px-3 py-2">
        ...
        <div className="mt-2 flex gap-2 overflow-x-auto pb-1 scrollbar-none">
          {activeSpaceItems.map((item) => {
            ...
            return (
              <Link
                ...
                className={`inline-flex shrink-0 items-center rounded-full border px-3 py-2 text-sm font-medium transition ${
                  isActive
          ...
          {activeSpaceItems.length === 0 ? (
            <span className="inline-flex shrink-0 items-center rounded-full border border-dashed border-slate-300 px-3 py-2 text-sm text-slate-500">
              {locale === "fr"
