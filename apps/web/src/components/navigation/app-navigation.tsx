...
export function AppNavigation({ currentProfile, isAdmin }: AppNavigationProps) {
 ...
 <p className="cmm-text-caption cmm-text-muted">{labels.summary}</p>
 {parcoursNavV2Enabled ? (
 <div className="mt-2 rounded-lg border border-emerald-200 bg-emerald-50 p-2 cmm-text-caption text-emerald-900">
 <p>
 Profil actif:{""}
 ...
 :"border-slate-200 bg-white cmm-text-secondary hover:border-emerald-200 hover:bg-emerald-50"
 }`}
 >
 <p className="cmm-text-small font-semibold">
...
"primary",
 ...
 className="inline-flex rounded-lg border border-emerald-300 bg-emerald-50 px-3 py-2 cmm-text-small font-semibold text-emerald-900 hover:bg-emerald-100"
 >
 {profileOverview.primaryCTA.label[locale]}
 </Link>
 {secondaryCTA ? (
