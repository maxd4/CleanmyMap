...
export function RolePrimaryActions({
 ...
 <h2 className="text-base font-semibold cmm-text-primary [data-display-mode='minimaliste']_&:text-2xl [data-display-mode='minimaliste']_&:font-bold underline decoration-emerald-500 decoration-4 underline-offset-4">
 {title}
 </h2>
 ...
 >
 <p className={`font-bold ${displayMode === 'minimaliste' ? 'text-xl' : 'cmm-text-small'}`}>
 {action.label[locale]}
 </p>
 <p className={`mt-1 cmm-text-muted font-medium ${displayMode === 'minimaliste' ? 'text-base opacity-90' : 'cmm-text-caption'}`}>
