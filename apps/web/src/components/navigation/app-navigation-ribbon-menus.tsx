      ...
      <CmmDropdown
        ...
        renderTrigger={(triggerProps) => (
          <button
            ...
            className="cmm-dropdown-trigger inline-flex h-11 min-w-11 items-center justify-center gap-2 rounded-full border border-white/10 bg-white/8 px-0 text-white transition-colors hover:border-rose-200/30 hover:bg-rose-300/14 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-rose-300/40 xl:w-auto xl:px-3 xl:h-10"
          >
            <MessageSquare className="h-4.5 w-4.5 shrink-0" aria-hidden="true" />
            <span className="cmm-ribbon-text hidden font-semibold xl:inline">Feedback</span>
            <ChevronDown className="hidden h-4 w-4 shrink-0 text-slate-300 xl:inline" aria-hidden="true" />
          </button>
        )}
      >
