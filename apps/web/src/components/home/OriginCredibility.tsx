...
export function OriginCredibility() {
 ...
 >
 <h2 className="text-4xl md:text-6xl font-bold mb-8 tracking-tight bg-gradient-to-r from-emerald-200 via-emerald-100 to-white bg-clip-text text-transparent">
 ...
 <h3 className="text-2xl md:text-3xl font-bold text-white">L&apos;histoire du projet</h3>
 </div>
 ...
 <motion.div 
 whileHover={{ x: 5 }}
 className="flex items-start gap-4 md:gap-5 p-5 md:p-6 bg-emerald-950/60 rounded-[1.2rem] md:rounded-[1.5rem] border border-emerald-500/30 text-emerald-200 cmm-text-small md:text-base italic leading-relaxed"
 >
 ...
 >
 <div className="text-emerald-400 font-bold cmm-text-caption uppercase tracking-[0.3em] mb-6 flex items-center gap-3">
 <Calendar className="w-4 h-4" /> Étape {item.step}
 </div>
 <h5 className="text-2xl font-bold mb-4 text-white group-hover:text-emerald-200 transition-colors">{item.title}</h5>
