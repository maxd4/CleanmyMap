...
export function LearnRubricShell({
  ...
  return (
    <div className="w-full space-y-8 p-4 md:p-8">
      <section className={`rounded-[2rem] bg-gradient-to-br ${ACCENT_CLASSES[accent]} p-6 text-white md:p-8`}>
        <div className="grid gap-6 lg:grid-cols-[1.05fr_0.95fr] lg:items-start">
          ...
          <aside className="overflow-hidden rounded-[1.75rem] border border-white/14 bg-white/10 p-4 shadow-[0_20px_40px_-28px_rgba(255,255,255,0.18)] backdrop-blur-sm">
            <div className="flex items-center justify-between gap-3">
              ...
              <div className="grid h-12 w-12 place-items-center rounded-2xl border border-white/16 bg-white/12">
            ...
            <div className="mt-4 grid gap-3 sm:grid-cols-3 lg:grid-cols-1">
              <div className="rounded-[1.4rem] border border-white/12 bg-black/10 p-4">
                <div className="flex items-center justify-between gap-2">
                  ...
                  <span className="text-[10px] font-black uppercase tracking-[0.18em] text-white/68">
                    01
                  </span>
                </div>
                <div className="mt-4 h-20 rounded-[1.1rem] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.18),rgba(255,255,255,0.04))] p-3">
                  <div className="h-2 w-16 rounded-full bg-white/30" />
                  <div className="mt-3 grid grid-cols-3 gap-2">
                    <span className="h-9 rounded-xl bg-white/18" />
                    <span className="h-12 rounded-xl bg-white/24" />
                    <span className="h-8 rounded-xl bg-white/16" />
                  </div>
                </div>
              ...
              <div className="rounded-[1.4rem] border border-white/12 bg-black/10 p-4">
                ...
                <div className="mt-4 grid gap-2">
                  {highlights?.slice(0, 2).map((item) => (
                    <span
                      key={item[locale]}
                      className="inline-flex items-center rounded-2xl border border-white/14 bg-white/10 px-3 py-2 text-[11px] font-black uppercase tracking-[0.18em] text-white/88"
                    >
                      {item[locale]}
                    </span>
                  ))}
              ...
              <div className="rounded-[1.4rem] border border-white/12 bg-black/10 p-4">
                ...
                <div className="mt-4 rounded-[1.1rem] border border-white/10 bg-white/8 p-3">
                  ...
                  <div className="mt-3 flex gap-2">
                    <span className="h-10 flex-1 rounded-2xl bg-white/14" />
                    <span className="h-10 flex-1 rounded-2xl bg-white/22" />
                  </div>
                </div>
                <p className="mt-3 text-sm font-semibold text-white/88">
