    ...
    <div className="space-y-8">
      ...
      <div className="text-center space-y-4">
        <div className="flex items-center justify-center gap-3">
          ...
          <h2 className="text-3xl font-black text-slate-900">Quiz Environnemental</h2>
        </div>
          ...
          {showAnswer && (
            ...
            >
              ...
              <div className="flex gap-3">
                ...
                <button
                  onClick={resetQuiz}
                  className="px-4 py-3 border-2 border-slate-200 text-slate-600 rounded-xl font-bold hover:bg-slate-50 transition-colors"
                >
                  <Shuffle size={20} />
                </button>
              </div>
      ...
      {completedQuestions.size > 0 && (
        ...
        >
          ...
          <h3 className="text-2xl font-black mb-2">Votre score</h3>
          <p className="text-lg">
