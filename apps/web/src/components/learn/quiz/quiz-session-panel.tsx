...
import { QuizSessionFeedback } from "./quiz-session-feedback";
import { buildQuizSessionPanelModel } from "./quiz-session-panel.model";
          ...
          {showAnswer ? (
            ...
            >
              <QuizSessionFeedback
                ...
                selectedOption={selectedOption}
                answerFeedbackTitle={answerFeedbackTitle}
                answerFeedbackBody={answerFeedbackBody}
                resolvedErrorType={resolvedErrorType}
                errorTargetFollowUp={errorTargetFollowUp}
                selectedOptionsLabel={selectedOptionsLabel}
                correctOptionsLabel={correctOptionsLabel}
                reviewTargetFollowUp={reviewTargetFollowUp}
              />
