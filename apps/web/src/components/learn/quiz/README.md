...
La logique, les contrats, la taxonomy, la sélection, la progression et les audits sont dans `apps/web/src/lib/learning/quiz/`. La direction autorisée est donc `components/learn/quiz/` vers le domaine Quiz ; le domaine ne doit jamais remonter vers cette UI.
