...
const BLOCK_THEME: Record<NavigationBlockId, {
  ...
  home: {
    ...
    badge:     "border-orange-200/25 bg-orange-100/12 text-orange-50",
  ...
  act: {
    ...
    iconColor: "text-white",
    badge:     "border-emerald-200/25 bg-emerald-100/12 text-emerald-50",
    border:    "border-emerald-200/18",
    glow:      "group-hover:shadow-emerald-950/28",
    cta:       "border-white/14 bg-white/10 text-white hover:bg-white/16",
    text:      "text-white",
    mutedText: "text-emerald-50/72",
    dot:       "bg-emerald-300",
    itemHover: "hover:border-white/12 hover:bg-white/8 hover:text-white",
  ...
  visualize: {
    ...
    iconBg:    "bg-sky-500",
    iconColor: "text-white",
    badge:     "border-sky-200/25 bg-sky-100/12 text-sky-50",
    border:    "border-sky-200/18",
    glow:      "group-hover:shadow-sky-950/28",
    cta:       "border-white/14 bg-white/10 text-white hover:bg-white/16",
    text:      "text-white",
    mutedText: "text-sky-50/72",
    dot:       "bg-sky-300",
    itemHover: "hover:border-white/12 hover:bg-white/8 hover:text-white",
    divider:   "bg-sky-200/32",
  },
  impact: {
    backgroundImage: "linear-gradient(135deg, #2a000e 0%, #4a0f1a 52%, #881337 100%)",
    ring:      "ring-rose-200/20",
    iconBg:    "bg-rose-500",
    iconColor: "text-white",
    badge:     "border-rose-200/25 bg-rose-100/12 text-rose-50",
    border:    "border-rose-200/18",
    glow:      "group-hover:shadow-rose-950/28",
    cta:       "border-white/14 bg-white/10 text-white hover:bg-white/16",
    text:      "text-white",
    mutedText: "text-rose-50/72",
    dot:       "bg-rose-300",
    itemHover: "hover:border-white/12 hover:bg-white/8 hover:text-white",
    divider:   "bg-rose-200/32",
  },
  network: {
    ...
    iconColor: "text-white",
    badge:     "border-indigo-200/25 bg-indigo-100/12 text-indigo-50",
  ...
  connect: {
    ...
    iconBg:    "bg-pink-500",
    iconColor: "text-white",
    badge:     "border-pink-200/25 bg-pink-100/12 text-pink-50",
  ...
  learn: {
    ...
    iconColor: "text-white",
    badge:     "border-yellow-200/25 bg-yellow-100/12 text-yellow-50",
  ...
  pilot: {
    ...
    iconBg:    "bg-amber-500",
    iconColor: "text-white",
    badge:     "border-amber-200/25 bg-amber-100/12 text-amber-50",
    border:    "border-amber-200/18",
    glow:      "group-hover:shadow-amber-950/28",
    cta:       "border-white/14 bg-white/10 text-white hover:bg-white/16",
    text:      "text-white",
    mutedText: "text-amber-50/72",
    dot:       "bg-amber-300",
    itemHover: "hover:border-white/12 hover:bg-white/8 hover:text-white",
    ...
    >
      <div className="relative z-10 mx-auto w-full max-w-[1400px] px-5 pb-20 pt-8 sm:px-8 sm:pt-10">
        ...
        <div className="mb-12 space-y-4">
          <h1 className="text-[clamp(3rem,6vw,5.5rem)] font-black leading-[0.92] tracking-[-0.05em] text-slate-950">
