          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="rounded-[2.5rem] border border-white/10 bg-white/[0.06] backdrop-blur-xl shadow-[0_32px_64px_-12px_rgba(0,0,0,0.45),0_0_0_1px_rgba(255,255,255,0.06)] px-8 py-10 sm:px-14 sm:py-14 lg:px-20 lg:py-20 space-y-10">
              ...
              <div className="space-y-4 sm:space-y-5">
                <h1 className="font-black text-white tracking-tighter leading-[0.95] animate-in fade-in slide-in-from-bottom-6 duration-700 delay-100"
                ...
                <div className="animate-in fade-in slide-in-from-bottom-6 duration-700 delay-150 flex items-center gap-3 pt-1 sm:gap-4">
                  ...
                  <p className="rounded-full border border-emerald-300/25 bg-emerald-400/8 px-3 py-1 text-[10px] sm:text-xs md:text-sm font-black uppercase tracking-[0.34em] text-emerald-300/95 whitespace-nowrap">
              ...
              <div className="animate-in fade-in slide-in-from-bottom-8 duration-700 delay-200 flex flex-col sm:flex-row sm:flex-wrap items-center gap-3 sm:gap-4 pt-2">
                ...
                <Link
                  href="/explorer"
                  className="inline-flex w-full sm:w-auto h-14 items-center justify-center gap-2 rounded-2xl border border-white/25 bg-white/8 px-7 text-sm font-extrabold uppercase tracking-wider text-white transition-all duration-300 hover:border-cyan-300/50 hover:bg-white/15 hover:text-cyan-100 active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/30 whitespace-nowrap"
                >
                  Explorer
                  <ArrowRight size={16} />
                </Link>
                ...
                <Link
                  href="/sign-in"
                  className="inline-flex w-full sm:w-auto h-14 items-center justify-center gap-2 rounded-2xl border-2 border-white/40 bg-white/10 px-8 text-base font-black text-white transition-all duration-300 hover:border-white/80 hover:bg-white/20 active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/40 whitespace-nowrap"
                >
                  Se connecter
                </Link>
                ...
                <Link
                  href="/reports"
                  className="inline-flex w-full sm:w-auto h-14 items-center justify-center gap-2 rounded-2xl border border-white/20 bg-white/5 px-6 text-sm font-bold text-white/90 transition-all duration-300 hover:border-white/30 hover:bg-white/10 active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/20 whitespace-nowrap"
                >
                  Rapport d’impact
                </Link>
            ...
            <div className="mb-10 flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
              <div className="space-y-2">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-sm font-black uppercase tracking-[0.25em] text-slate-900 dark:text-white whitespace-nowrap">
                    Impact consolidé — 12 mois
                  </h2>
                </div>
                <p className="pl-[28px] text-sm text-slate-500 dark:text-slate-400">
              ...
              <Link
                ...
                className="inline-flex w-max items-center gap-2.5 self-start rounded-xl border border-slate-200 bg-white px-5 py-3 text-[12px] font-black uppercase tracking-widest text-slate-700 shadow-sm transition-all duration-300 hover:border-blue-400 hover:text-blue-700 hover:shadow-lg active:scale-95 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-300 dark:hover:border-blue-500 dark:hover:text-blue-300 whitespace-nowrap"
              >
                <Info size={14} />
                Méthodologie
              </Link>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="mb-5 flex items-center justify-between">
                      <span className={`inline-flex items-center rounded-lg px-2.5 py-1 text-[10px] font-black uppercase tracking-widest ring-1 ${s.badge} whitespace-nowrap`}>
                        {m.category}
                      </span>
                    ...
                    {/* valeur */}
                    <div className={`font-black tabular-nums leading-none tracking-tighter ${s.value} text-wrap`}
                      style={{fontSize: "clamp(1.75rem, 3.2vw, 2.75rem)"}}>
                      {m.value}
                    </div>

                    {/* libellé */}
                    <p className="mt-4 text-xs font-bold uppercase tracking-widest text-slate-500 dark:text-slate-400 leading-tight">
                      {m.label}
                    </p>
                  </div>
                );
      ...
      <section className="relative w-full overflow-hidden px-3 py-16 sm:px-5 sm:py-20 lg:px-8 lg:py-24">
        ...
        <div className="relative z-10 mx-auto max-w-7xl">
          ...
          <div className="mb-10 space-y-2 text-center px-4">
            <h2 className="text-3xl font-black tracking-tight text-white sm:text-4xl lg:text-5xl" style={{textWrap: "pretty"}}>
              Les sept piliers de CleanMyMap
            </h2>
            <p className="text-sm font-light text-white/55 sm:text-base mx-auto max-w-2xl leading-relaxed">
          ...
          <div className="flex flex-wrap justify-center gap-4 px-4">
            {[
              ...
              >
                ...
                {/* lien */}
                <div className={`mt-5 flex items-center gap-2 text-[11px] font-bold uppercase tracking-widest ${bloc.iconColor} opacity-60 group-hover:opacity-100 transition-opacity whitespace-nowrap`}>
      ...
      <section className="relative w-full overflow-hidden px-4 py-16 sm:px-6 sm:py-24 lg:px-8 lg:py-32">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4">
          <div className="mb-12 space-y-3 text-center">
            <p className="text-xs font-bold uppercase tracking-[0.3em] text-cyan-700 dark:text-cyan-400">
              Bénéfices
            </p>
            <h2 className="text-3xl font-black tracking-tight text-slate-900 sm:text-4xl lg:text-5xl dark:text-white" style={{textWrap: "pretty"}}>
              Pourquoi utiliser CleanMyMap ?
            </h2>
            <p className="mx-auto max-w-2xl text-base font-light text-slate-500 sm:text-lg dark:text-slate-400 leading-relaxed">
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              >
                ...
                <p className="text-sm leading-relaxed text-slate-600 dark:text-slate-400" style={{textWrap: "pretty"}}>
                  {item.desc}
                </p>
              </div>
            ))}
          ...
          <div className="flex flex-col items-center justify-between gap-12 lg:flex-row lg:gap-8">
            ...
            <div className="flex flex-col items-center lg:items-start space-y-3">
              <div className="flex items-center gap-3">
                ...
                <p className="text-xs font-black uppercase tracking-[0.3em] text-emerald-400">Contact</p>
              </div>
            ...
            <div className="flex flex-wrap justify-center gap-5">
              ...
              >
                ...
                <span className="text-sm font-bold text-slate-200 group-hover:text-white transition-colors">maxence.drm@gmail.com</span>
              </a>
              <a
              ...
              >
                ...
                <span className="text-sm font-bold text-slate-200 group-hover:text-white transition-colors">@max_drm4</span>
              </a>
            </div>
            ...
            <div className="flex flex-col items-center text-center lg:items-end lg:text-right space-y-4">
              <div className="flex flex-col lg:flex-row lg:items-center gap-3 lg:gap-6">
                <p className="text-base sm:text-lg font-black tracking-tight text-white uppercase whitespace-nowrap">
                ...
                <div className="flex items-center justify-center gap-4">
                  <p className="text-[11px] font-black tracking-[0.25em] text-emerald-400/90 uppercase whitespace-nowrap">Cultivons l&apos;entraide</p>
                  <span className="h-1 w-1 rounded-full bg-slate-700" />
                  <p className="text-[11px] font-medium text-slate-500/80 uppercase tracking-widest whitespace-nowrap">© 2026 CleanMyMap</p>
                </div>
              </div>
            </div>
