        ...
        <section className="space-y-5">
          ...
          <DataList
            items={[
              ...
              "legal_content_report_decisions : l'historique append-only des décisions et de l'audit est conservé avec le signalement pour la traçabilité. Aucune durée fixe supplémentaire n'est configurée ; une demande d'effacement ou de limitation est examinée au regard des obligations de preuve, des droits des tiers et de la nécessité du suivi.",
