...
export default function MethodologiePage() {
 ...
 <div className="flex items-center gap-2 text-emerald-600 font-bold uppercase tracking-widest cmm-text-caption">
 <Beaker size={14} />
 {t("header_suptitle")}
 </div>
 <h1 className="text-4xl sm:text-5xl font-bold tracking-tight cmm-text-primary">
 {t("header_title")}
 </h1>
 <p className="text-lg cmm-text-secondary">
 {t("header_desc")}
 </p>
 </header>
 ...
 <div className="bg-slate-50 p-4 rounded-xl font-mono cmm-text-small border-l-4 border-blue-500">
 {t("cards.water.formula", { val: factors.waterLitersPerCigaretteButt })}
 </div>
 <p className="cmm-text-small cmm-text-secondary leading-relaxed text-justify">
 {t("cards.water.desc", { val: factors.waterLitersPerCigaretteButt })}
 </p>
 <div className="pt-2 cmm-text-caption font-bold cmm-text-muted">
 ...
 <div className="bg-slate-50 p-4 rounded-xl font-mono cmm-text-small border-l-4 border-emerald-500">
 ...
 {/* SURFACE CLEANED */}
 <div className="rounded-3xl border border-slate-200 bg-white p-8 space-y-4 shadow-sm hover:shadow-md transition-shadow">
 <div className="flex items-center gap-3 cmm-text-primary">
 <Info size={24} />
 <h2 className="text-xl font-bold">{t("cards.surface.title")}</h2>
 </div>
 <div className="bg-slate-50 p-4 rounded-xl font-mono cmm-text-small border-l-4 border-slate-900">
 ...
 <div className="bg-slate-50 p-4 rounded-xl font-mono cmm-text-small border-l-4 border-rose-500">
 {t("cards.map.formula")}
 </div>
 <p className="cmm-text-small cmm-text-secondary leading-relaxed text-justify">
 {t("cards.map.desc")}
 ...
 <div className="bg-slate-50 p-4 rounded-xl font-mono cmm-text-small border-l-4 border-amber-500">
 {t("cards.roi.formula")}
 </div>
 <p className="cmm-text-small cmm-text-secondary leading-relaxed text-justify">
 {t("cards.roi.desc")}
 </p>
 <div className="pt-2 cmm-text-caption font-bold cmm-text-muted font-mono italic">
 {t("cards.roi.source")}
 </div>
 </div>
 </section>

 <footer className="pt-12 border-t border-slate-100 flex flex-col sm:flex-row items-center justify-between gap-6 cmm-text-muted">
 <div className="cmm-text-caption space-y-1">
