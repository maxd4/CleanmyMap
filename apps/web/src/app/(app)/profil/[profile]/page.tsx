...
export default async function ProfilPage({ params }: ProfilPageProps) {
 ...
 <p className="mt-2 cmm-text-small cmm-text-secondary">{profileSubtitle}.</p>
 ...
 className="rounded-lg border border-slate-200 px-3 py-2 cmm-text-small cmm-text-secondary hover:bg-slate-50"
 >
