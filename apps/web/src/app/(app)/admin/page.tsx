...
export default async function AdminPage() {
 ...
 <p className="mt-2 cmm-text-caption cmm-text-secondary">Etat: pending / accepted / rejected</p>
 <p className="mt-3 cmm-text-caption cmm-text-secondary">
 ...
 <p className="mt-2 cmm-text-caption cmm-text-secondary">Etat: success / error</p>
 <p className="mt-3 cmm-text-caption cmm-text-secondary">
