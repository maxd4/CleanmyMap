...
"Super Admin";
 ...
 <div className="flex items-center gap-2 text-rose-500 font-bold uppercase tracking-widest cmm-text-caption">
 <ShieldAlert size={16} />
 Système d&apos;Exploitation Master
 </div>
 <h1 className="text-4xl font-bold tracking-tight text-white flex items-center gap-4">
 God Mode. <span className="text-rose-600 px-2 py-1 bg-rose-600/10 rounded-lg cmm-text-caption uppercase tracking-widest">SuperAdmin</span>
 </h1>
 ...
 <div className="cmm-text-caption">
 ...
 className="bg-slate-950 border border-slate-800 rounded-lg px-3 py-1.5 cmm-text-caption text-white outline-none focus:border-rose-500 transition-colors"
 />
 </div>
 </div>
 
 <div className="overflow-x-auto">
 <table className="w-full text-left cmm-text-small">
 <thead>
 <tr className="border-b border-slate-800 cmm-text-muted uppercase cmm-text-caption font-bold tracking-widest">
 ...
 <p className="cmm-text-caption cmm-text-muted italic">{primaryEmail}</p>
 </td>
 <td className="py-4 px-2">
 <span className="px-2 py-0.5 bg-rose-600/20 text-rose-500 rounded-full cmm-text-caption font-bold uppercase tracking-tighter border border-rose-600/30">
 Super Admin
 </span>
 </td>
 <td className="py-4 px-2 cmm-text-muted cmm-text-caption">Il y a 2 min</td>
 <td className="py-4 px-2">
 <span className="cmm-text-muted cmm-text-caption">Session active</span>
 </td>
 </tr>
 </tbody>
 </table>
 </div>
 <p className="cmm-text-caption cmm-text-muted text-center italic">
 ...
 <div>
 <p className="cmm-text-small font-bold">Administration opérationnelle</p>
 <p className="cmm-text-caption cmm-text-muted uppercase tracking-widest font-bold">Modération, gouvernance, audit</p>
 </div>
 </Link>
 ...
 <div>
 <p className="cmm-text-small font-bold">Rapports d&apos;impact</p>
 <p className="cmm-text-caption cmm-text-muted uppercase tracking-widest font-bold">Exports et lecture décideur</p>
 </div>
 </Link>
 ...
 <div>
 <p className="cmm-text-small font-bold">Santé des services</p>
 <p className="cmm-text-caption cmm-text-muted uppercase tracking-widest font-bold">Endpoint /api/health</p>
 </div>
 </a>
 </div>
 </div>
 ...
 <h4 className="font-bold uppercase tracking-[0.2em] cmm-text-caption">Avertissement de Sécurité</h4>
 <p className="cmm-text-small leading-relaxed opacity-90">Toutes vos actions sur ce panel sont logguées et immuables. Chaque injection de données affecte directement les KPI de pilotage global.</p>
 </div>
 </section>
 </div>
 </div>
