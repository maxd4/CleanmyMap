-- Extend the canonical admin audit contract for role assignment and revocation.
-- This is intentionally idempotent so the migration can be safely re-applied.
do $$
declare
...
begin
  ...
  alter table public.admin_operations_audit
    ...
    check (operation_type in ('moderation', 'import_dry_run', 'import_confirm', 'role_management'));
end;
$$;
