...
def test_normalize_repo_write_removes_bom_and_preserves_valid_unicode(tmp_path: Path) -> None:
...
def test_analyze_file_preserves_valid_french_document(tmp_path: Path) -> None:
